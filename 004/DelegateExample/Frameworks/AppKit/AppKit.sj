...
p;11;CPControl.ji;8;CPFont.ji;10;CPShadow.ji;8;CPView.jc;17266;
...
}),new objj_method(sel_getUid("setToolTip:"),function(_34,_35,_36){
with(_34){
if(_toolTip==_36){
return;
}
_toolTip=_36;
_DOMElement.title=_36;
}
}),new objj_method(sel_getUid("toolTip"),function(_37,_38){
with(_37){
return _toolTip;
}
...
}),new objj_method(sel_getUid("target"),function(_3e,_3f){
with(_3e){
return _target;
}
}),new objj_method(sel_getUid("setTarget:"),function(_40,_41,_42){
with(_40){
_target=_42;
}
}),new objj_method(sel_getUid("tracksMouseOutsideOfFrame"),function(_43,_44){
with(_43){
return NO;
}
}),new objj_method(sel_getUid("trackMouse:"),function(_45,_46,_47){
with(_45){
var _48=objj_msgSend(_47,"type"),_49=objj_msgSend(_45,"convertPoint:fromView:",objj_msgSend(_47,"locationInWindow"),nil);
isWithinFrame=objj_msgSend(_45,"tracksMouseOutsideOfFrame")||CGRectContainsPoint(objj_msgSend(_45,"bounds"),_49);
if(_48===CPLeftMouseUp){
objj_msgSend(_45,"stopTracking:at:mouseIsUp:",_previousTrackingLocation,_49,YES);
_trackingMouseDownFlags=0;
}else{
if(_48===CPLeftMouseDown){
_trackingMouseDownFlags=objj_msgSend(_47,"modifierFlags");
_continuousTracking=objj_msgSend(_45,"startTrackingAt:",_49);
}else{
...
_continuousTracking=objj_msgSend(_45,"continueTracking:at:",_previousTrackingLocation,_49);
}
}
}else{
objj_msgSend(_45,"stopTracking:at:mouseIsUp:",_previousTrackingLocation,_49,NO);
}
}
}
objj_msgSend(CPApp,"setTarget:selector:forNextEventMatchingMask:untilDate:inMode:dequeue:",_45,sel_getUid("trackMouse:"),CPLeftMouseDraggedMask|CPLeftMouseUpMask,nil,nil,YES);
}
if((_sendActionOn&(1<<_48))&&isWithinFrame){
objj_msgSend(_45,"sendAction:to:",_action,_target);
}
_trackingWasInFrame=isWithinFrame;
_previousTrackingLocation=_49;
}
}),new objj_method(sel_getUid("mouseDownFlags"),function(_4a,_4b){
with(_4a){
...
objj_msgSend(_58,"trackMouse:",_5a);
}
}),new objj_method(sel_getUid("sendAction:to:"),function(_5b,_5c,_5d,_5e){
with(_5b){
objj_msgSend(CPApp,"sendAction:to:from:",_5d,_5e,_5b);
}
}),new objj_method(sel_getUid("sendActionOn:"),function(_5f,_60,_61){
with(_5f){
var _62=_sendActionOn;
_sendActionOn=_61;
return _62;
}
}),new objj_method(sel_getUid("isContinuous"),function(_63,_64){
with(_63){
return (_sendActionOn&CPPeriodicMask)!==0;
}
}),new objj_method(sel_getUid("setContinuous:"),function(_65,_66,_67){
with(_65){
if(_67){
...
}),new objj_method(sel_getUid("setObjectValue:"),function(_6a,_6b,_6c){
with(_6a){
_value=_6c;
}
}),new objj_method(sel_getUid("floatValue"),function(_6d,_6e){
with(_6d){
var _6f=parseFloat(_value,10);
return isNaN(_6f)?0:_6f;
}
}),new objj_method(sel_getUid("setFloatValue:"),function(_70,_71,_72){
with(_70){
objj_msgSend(_70,"setObjectValue:",_72);
}
}),new objj_method(sel_getUid("doubleValue"),function(_73,_74){
with(_73){
var _75=parseFloat(_value,10);
return isNaN(_75)?0:_75;
}
}),new objj_method(sel_getUid("setDoubleValue:"),function(_76,_77,_78){
with(_76){
objj_msgSend(_76,"setObjectValue:",_78);
}
}),new objj_method(sel_getUid("intValue"),function(_79,_7a){
with(_79){
var _7b=parseInt(_value,10);
return isNaN(_7b)?0:_7b;
}
}),new objj_method(sel_getUid("setIntValue:"),function(_7c,_7d,_7e){
with(_7c){
objj_msgSend(_7c,"setObjectValue:",_7e);
}
}),new objj_method(sel_getUid("integerValue"),function(_7f,_80){
with(_7f){
var _81=parseInt(_value,10);
return isNaN(_81)?0:_81;
}
}),new objj_method(sel_getUid("setIntegerValue:"),function(_82,_83,_84){
with(_82){
objj_msgSend(_82,"setObjectValue:",_84);
}
}),new objj_method(sel_getUid("stringValue"),function(_85,_86){
with(_85){
return _value?String(_value):"";
}
}),new objj_method(sel_getUid("setStringValue:"),function(_87,_88,_89){
with(_87){
objj_msgSend(_87,"setObjectValue:",_89);
}
}),new objj_method(sel_getUid("takeDoubleValueFrom:"),function(_8a,_8b,_8c){
with(_8a){
if(objj_msgSend(_8c,"respondsToSelector:",sel_getUid("doubleValue"))){
objj_msgSend(_8a,"setDoubleValue:",objj_msgSend(_8c,"doubleValue"));
}
}
}),new objj_method(sel_getUid("takeFloatValueFrom:"),function(_8d,_8e,_8f){
with(_8d){
if(objj_msgSend(_8f,"respondsToSelector:",sel_getUid("floatValue"))){
objj_msgSend(_8d,"setFloatValue:",objj_msgSend(_8f,"floatValue"));
}
}
}),new objj_method(sel_getUid("takeIntegerValueFrom:"),function(_90,_91,_92){
with(_90){
if(objj_msgSend(_92,"respondsToSelector:",sel_getUid("integerValue"))){
objj_msgSend(_90,"setIntegerValue:",objj_msgSend(_92,"integerValue"));
}
}
}),new objj_method(sel_getUid("takeIntValueFrom:"),function(_93,_94,_95){
with(_93){
if(objj_msgSend(_95,"respondsToSelector:",sel_getUid("intValue"))){
objj_msgSend(_93,"setIntValue:",objj_msgSend(_95,"intValue"));
}
}
}),new objj_method(sel_getUid("takeObjectValueFrom:"),function(_96,_97,_98){
with(_96){
if(objj_msgSend(_98,"respondsToSelector:",sel_getUid("objectValue"))){
objj_msgSend(_96,"setObjectValue:",objj_msgSend(_98,"objectValue"));
}
}
}),new objj_method(sel_getUid("takeStringValueFrom:"),function(_99,_9a,_9b){
with(_99){
if(objj_msgSend(_9b,"respondsToSelector:",sel_getUid("stringValue"))){
objj_msgSend(_99,"setStringValue:",objj_msgSend(_9b,"stringValue"));
}
}
}),new objj_method(sel_getUid("setBackgroundColor:"),function(_9c,_9d,_9e){
with(_9c){
_backgroundColors=objj_msgSend(CPDictionary,"dictionary");
objj_msgSend(_9c,"setBackgroundColor:forName:",_9e,CPControlNormalBackgroundColor);
objj_msgSendSuper({receiver:_9c,super_class:objj_getClass("CPView")},"setBackgroundColor:",_9e);
}
}),new objj_method(sel_getUid("setBackgroundColor:forName:"),function(_9f,_a0,_a1,_a2){
with(_9f){
if(!_a1){
objj_msgSend(_backgroundColors,"removeObjectForKey:",_a2);
}else{
objj_msgSend(_backgroundColors,"setObject:forKey:",_a1,_a2);
}
if(_currentBackgroundColorName==_a2){
objj_msgSend(_9f,"setBackgroundColorWithName:",_currentBackgroundColorName);
}
}
}),new objj_method(sel_getUid("backgroundColorForName:"),function(_a3,_a4,_a5){
with(_a3){
var _a6=objj_msgSend(_backgroundColors,"objectForKey:",_a5);
if(!_a6&&_a5!=CPControlNormalBackgroundColor){
return objj_msgSend(_backgroundColors,"objectForKey:",CPControlNormalBackgroundColor);
}
return _a6;
}
}),new objj_method(sel_getUid("setBackgroundColorWithName:"),function(_a7,_a8,_a9){
with(_a7){
_currentBackgroundColorName=_a9;
objj_msgSendSuper({receiver:_a7,super_class:objj_getClass("CPView")},"setBackgroundColor:",objj_msgSend(_a7,"backgroundColorForName:",_a9));
}
}),new objj_method(sel_getUid("textDidBeginEditing:"),function(_aa,_ab,_ac){
with(_aa){
if(objj_msgSend(_ac,"object")!=_aa){
return;
}
objj_msgSend(objj_msgSend(CPNotificationCenter,"defaultCenter"),"postNotificationName:object:userInfo:",CPControlTextDidBeginEditingNotification,_aa,objj_msgSend(CPDictionary,"dictionaryWithObject:forKey:",objj_msgSend(_ac,"object"),"CPFieldEditor"));
}
}),new objj_method(sel_getUid("textDidChange:"),function(_ad,_ae,_af){
with(_ad){
if(objj_msgSend(_af,"object")!=_ad){
return;
}
objj_msgSend(objj_msgSend(CPNotificationCenter,"defaultCenter"),"postNotificationName:object:userInfo:",CPControlTextDidChangeNotification,_ad,objj_msgSend(CPDictionary,"dictionaryWithObject:forKey:",objj_msgSend(_af,"object"),"CPFieldEditor"));
}
}),new objj_method(sel_getUid("textDidEndEditing:"),function(_b0,_b1,_b2){
with(_b0){
if(objj_msgSend(_b2,"object")!=_b0){
return;
}
objj_msgSend(objj_msgSend(CPNotificationCenter,"defaultCenter"),"postNotificationName:object:userInfo:",CPControlTextDidEndEditingNotification,_b0,objj_msgSend(CPDictionary,"dictionaryWithObject:forKey:",objj_msgSend(_b2,"object"),"CPFieldEditor"));
}
})]);
var _b3="CPControlValueKey",_b4="CPControlIsEnabledKey",_b5="CPControlAlignmentKey",_b6="CPControlVerticalAlignmentKey",_b7="CPControlFontKey",_b8="CPControlTextColorKey",_b9="CPControlTargetKey",_ba="CPControlActionKey",_bb="CPControlSendActionOnKey";
var _bc="CPImageViewImageKey";
...
with(_bd){
_bd=objj_msgSendSuper({receiver:_bd,super_class:objj_getClass("CPView")},"initWithCoder:",_bf);
if(_bd){
objj_msgSend(_bd,"setObjectValue:",objj_msgSend(_bf,"decodeObjectForKey:",_b3));
if(objj_msgSend(_bf,"containsValueForKey:",_bc)){
objj_msgSend(_bd,"setObjectValue:",objj_msgSend(_bf,"decodeObjectForKey:",_DeprecatedCPImageViewImageKey));
}
objj_msgSend(_bd,"setEnabled:",objj_msgSend(_bf,"decodeBoolForKey:",_b4));
objj_msgSend(_bd,"setAlignment:",objj_msgSend(_bf,"decodeIntForKey:",_b5));
objj_msgSend(_bd,"setVerticalAlignment:",objj_msgSend(_bf,"decodeIntForKey:",_b6));
objj_msgSend(_bd,"setFont:",objj_msgSend(_bf,"decodeObjectForKey:",_b7));
objj_msgSend(_bd,"setTextColor:",objj_msgSend(_bf,"decodeObjectForKey:",_b8));
objj_msgSend(_bd,"setTarget:",objj_msgSend(_bf,"decodeObjectForKey:",_b9));
objj_msgSend(_bd,"setAction:",objj_msgSend(_bf,"decodeObjectForKey:",_ba));
objj_msgSend(_bd,"sendActionOn:",objj_msgSend(_bf,"decodeIntForKey:",_bb));
}
return _bd;
}
}),new objj_method(sel_getUid("encodeWithCoder:"),function(_c0,_c1,_c2){
with(_c0){
objj_msgSendSuper({receiver:_c0,super_class:objj_getClass("CPView")},"encodeWithCoder:",_c2);
objj_msgSend(_c2,"encodeObject:forKey:",_value,_b3);
objj_msgSend(_c2,"encodeBool:forKey:",_isEnabled,_b4);
objj_msgSend(_c2,"encodeInt:forKey:",_alignment,_b5);
objj_msgSend(_c2,"encodeInt:forKey:",_verticalAlignment,_b6);
objj_msgSend(_c2,"encodeObject:forKey:",_font,_b7);
objj_msgSend(_c2,"encodeObject:forKey:",_textColor,_b8);
objj_msgSend(_c2,"encodeConditionalObject:forKey:",_target,_b9);
objj_msgSend(_c2,"encodeObject:forKey:",_action,_ba);
objj_msgSend(_c2,"encodeInt:forKey:",_sendActionOn,_bb);
}
})]);
var _c3=[],_c4={},_c5={},_c6={};
_c3[CPRegularControlSize]="Regular";
_c3[CPSmallControlSize]="Small";
_c3[CPMiniControlSize]="Mini";
...
_CPControlThreePartImages=function(_cf,_d0){
var _d1=1,_d2=arguments.length,_d3="";
for(;_d1<_d2;++_d1){
_d3+=arguments[_d1];
}
var _d4=_c4[_d3];
if(!_d4){
var _d5=objj_msgSend(CPBundle,"bundleForClass:",objj_msgSend(CPControl,"class")),_d6=_d0+"/"+_d3;
_cf=_cf[_d3];
_d4=[objj_msgSend(objj_msgSend(CPImage,"alloc"),"initWithContentsOfFile:size:",objj_msgSend(_d5,"pathForResource:",_d6+"0.png"),_cf[0]),objj_msgSend(objj_msgSend(CPImage,"alloc"),"initWithContentsOfFile:size:",objj_msgSend(_d5,"pathForResource:",_d6+"1.png"),_cf[1]),objj_msgSend(objj_msgSend(CPImage,"alloc"),"initWithContentsOfFile:size:",objj_msgSend(_d5,"pathForResource:",_d6+"2.png"),_cf[2])];
_c4[_d3]=_d4;
}
return _d4;
};
_CPControlThreePartImagePattern=function(_d7,_d8,_d9){
var _da=2,_db=arguments.length,_dc="";
for(;_da<_db;++_da){
_dc+=arguments[_da];
}
var _dd=_c6[_dc];
if(!_dd){
var _de=objj_msgSend(CPBundle,"bundleForClass:",objj_msgSend(CPControl,"class")),_df=_d9+"/"+_dc;
_d8=_d8[_dc];
_dd=objj_msgSend(CPColor,"colorWithPatternImage:",objj_msgSend(objj_msgSend(CPThreePartImage,"alloc"),"initWithImageSlices:isVertical:",[objj_msgSend(objj_msgSend(CPImage,"alloc"),"initWithContentsOfFile:size:",objj_msgSend(_de,"pathForResource:",_df+"0.png"),_d8[0]),objj_msgSend(objj_msgSend(CPImage,"alloc"),"initWithContentsOfFile:size:",objj_msgSend(_de,"pathForResource:",_df+"1.png"),_d8[1]),objj_msgSend(objj_msgSend(CPImage,"alloc"),"initWithContentsOfFile:size:",objj_msgSend(_de,"pathForResource:",_df+"2.png"),_d8[2])],_d7));
_c6[_dc]=_dd;
}
return _dd;
};
...
p;13;CPTextField.ji;11;CPControl.ji;17;CPStringDrawing.jc;20107;
...
with(_5a){
if(_placeholderString&&objj_msgSend(_5a,"stringValue")===_placeholderString){
_value="";
}
