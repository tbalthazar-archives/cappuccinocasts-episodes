@STATIC;1.0;p;13;CPArray+KVO.ji;9;CPArray.jc;11598;
...
p;9;CPArray.ji;10;CPObject.ji;9;CPRange.ji;14;CPEnumerator.ji;18;CPSortDescriptor.ji;13;CPException.jc;17789;
...
p;14;CPDictionary.ji;10;CPObject.ji;14;CPEnumerator.ji;13;CPException.jc;6997;
...
with(_37){
for(var i=0,_3b=_39.length;i<_3b;i++){
dictionary_removeValue(_37,_39[i]);
}
}
}),new objj_method(sel_getUid("setObject:forKey:"),function(_3c,_3d,_3e,_3f){
with(_3c){
dictionary_setValue(_3c,_3f,_3e);
}
}),new objj_method(sel_getUid("addEntriesFromDictionary:"),function(_40,_41,_42){
with(_40){
if(!_42){
return;
}
var _43=objj_msgSend(_42,"allKeys"),_44=objj_msgSend(_43,"count");
while(_44--){
var key=_43[_44];
objj_msgSend(_40,"setObject:forKey:",objj_msgSend(_42,"objectForKey:",key),key);
}
}
}),new objj_method(sel_getUid("description"),function(_46,_47){
with(_46){
var _48="CPDictionary {\n";
var i=_keys.length;
while(i--){
_48+=_keys[i]+":"+objj_msgSend(_buckets[_keys[i]],"description")+"\n";
}
_48+="}";
return _48;
}
...
p;19;CPKeyedUnarchiver.ji;8;CPNull.ji;9;CPCoder.jc;8105;
...
p;10;CPString.ji;10;CPObject.ji;13;CPException.ji;18;CPSortDescriptor.ji;9;CPValue.jc;9097;
...
p;9;CPValue.ji;10;CPObject.ji;9;CPCoder.jc;2907;
