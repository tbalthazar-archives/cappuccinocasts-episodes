@STATIC;1.0;p;9;CPArray.ji;10;CPObject.ji;9;CPRange.ji;14;CPEnumerator.ji;18;CPSortDescriptor.ji;13;CPException.jc;25241;
...
p;10;CPBundle.ji;10;CPObject.ji;14;CPDictionary.jc;2173;
...
objj_registerClassPair(the_class);
objj_addClassForBundle(the_class, objj_getBundleWithPath(OBJJ_CURRENT_BUNDLE.path));
class_addMethods(the_class, [new objj_method(sel_getUid("classNamed:"), function $CPBundle__classNamed_(self, _cmd, aString)
{ with(self)
{
}
...
p;14;CPDictionary.ji;10;CPObject.ji;14;CPEnumerator.ji;13;CPException.jc;6980;
...
p;17;CPKeyedArchiver.ji;8;CPData.ji;9;CPCoder.ji;9;CPArray.ji;10;CPString.ji;10;CPNumber.ji;14;CPDictionary.ji;9;CPValue.jc;16301;
...
p;19;CPKeyedUnarchiver.ji;8;CPNull.ji;9;CPCoder.jc;11988;
...
}), new objj_method(sel_getUid("_decodeArrayOfObjectsForKey:"), function $CPKeyedUnarchiver___decodeArrayOfObjectsForKey_(self, _cmd, aKey)
{ with(self)
{
...
p;18;CPKeyValueCoding.ji;9;CPArray.ji;10;CPObject.ji;14;CPDictionary.jc;10828;
...
{ with(self)
{
    ...
    else
    {
        ...
        while (object = objj_msgSend(enumerator, "nextObject"))
        {
            ...
            if (!value && value !== "")
                value = objj_msgSend(NSNull, "null");
            newArray.push(value);
        }
        return newArray;
    }
...
p;21;CPKeyValueObserving.ji;9;CPArray.ji;14;CPDictionary.ji;13;CPException.ji;10;CPObject.jc;17764;
{
var the_class = objj_getClass("CPObject")
if(!the_class) objj_exception_throw(new objj_exception(OBJJClassNotFoundException, "*** Could not find definition for class \"CPObject\""));
...
}), new objj_method(sel_getUid("automaticallyNotifiesObserversForKey:"), function $CPObject__automaticallyNotifiesObserversForKey_(self, _cmd, aKey)
{ with(self)
{
    return YES;
}
...
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_targetObject"), new objj_ivar("_nativeClass"), new objj_ivar("_changesForKey"), new objj_ivar("_observersForKey"), new objj_ivar("_replacementMethods")]);
objj_registerClassPair(the_class);
objj_addClassForBundle(the_class, objj_getBundleWithPath(OBJJ_CURRENT_BUNDLE.path));
...
}), new objj_method(sel_getUid("_replaceSetters"), function $_CPKVOProxy___replaceSetters(self, _cmd)
{ with(self)
{
    var currentClass = objj_msgSend(_targetObject, "class");
    while (currentClass && currentClass != currentClass.super_class)
    {
        ...
        for (var i=0; i<count; i++)
        {
            ...
            if (newMethod)
                objj_msgSend(_replacementMethods, "setObject:forKey:", newMethod, methodList[i].name);
        }
...
}), new objj_method(sel_getUid("_sendNotificationsForKey:isBefore:"), function $_CPKVOProxy___sendNotificationsForKey_isBefore_(self, _cmd, aKey, isBefore)
{ with(self)
{
    var changes = objj_msgSend(_changesForKey, "objectForKey:", aKey);
    if (isBefore)
    {
        changes = objj_msgSend(CPDictionary, "dictionary");
...
{ with(self)
{
    if (!aKey)
        return;
    objj_msgSend(objj_msgSend(_CPKVOProxy, "proxyForObject:", self), "_sendNotificationsForKey:isBefore:", aKey, YES);
}
...
{ with(self)
{
    if (!aKey)
        return;
    objj_msgSend(objj_msgSend(_CPKVOProxy, "proxyForObject:", self), "_sendNotificationsForKey:isBefore:", aKey, NO);
}
...
var _kvoKeyForSetter = _kvoKeyForSetter= function(selector)
{
    if (selector.split(":").length > 2 || !(objj_msgSend(selector, "hasPrefix:", "set") || objj_msgSend(selector, "hasPrefix:", "_set")))
        return nil;
...
var _kvoMethodForMethod = _kvoMethodForMethod= function(theObject, theMethod)
{
    var methodName = theMethod.name,
        methodImplementation = theMethod.method_imp,
        setterKey = _kvoKeyForSetter(methodName);
    if (setterKey && objj_msgSend(theObject, sel_getUid("automaticallyNotifiesObserversForKey:"), setterKey))
    {
        var newMethodImp = function(self)
        {
            objj_msgSend(self, "willChangeValueForKey:", setterKey);
            methodImplementation.apply(self, arguments);
            objj_msgSend(self, "didChangeValueForKey:", setterKey);
        }
        return newMethodImp;
    }
    return nil;
...
p;7;CPLog.jc;10061;window.CPLogDisable = false;
...
p;10;CPObject.jc;8386;{var the_class = objj_allocateClassPair(Nil, "CPObject"),
...
p;9;CPRange.jc;1731;CPMakeRange= function(location, length)
{
...
p;11;CPRunLoop.ji;10;CPObject.ji;9;CPArray.ji;10;CPString.jc;9637;
...
p;10;CPString.ji;10;CPObject.ji;13;CPException.ji;18;CPSortDescriptor.jc;17411;
...
p;17;CPURLConnection.ji;10;CPObject.ji;11;CPRunLoop.ji;14;CPURLRequest.ji;15;CPURLResponse.jc;5693;
...
p;15;CPURLResponse.ji;10;CPObject.jc;989;
...
objj_registerClassPair(the_class);
objj_addClassForBundle(the_class, objj_getBundleWithPath(OBJJ_CURRENT_BUNDLE.path));
class_addMethods(the_class, [new objj_method(sel_getUid("_initWithStatusCode:"), function $CPHTTPURLResponse___initWithStatusCode_(self, _cmd, aStatusCode)
{ with(self)
{
