...
p;17;CPCompatibility.ji;9;CPEvent.ji;12;CPPlatform.jc;3357;
...
p;8;CPMenu.jI;20;Foundation/CPArray.jI;25;Foundation/CPDictionary.jI;33;Foundation/CPNotificationCenter.jI;21;Foundation/CPString.ji;15;CPApplication.ji;12;CPClipView.ji;12;CPMenuItem.ji;9;CPPanel.jc;49837;
...
for(;_92<_93;++_92){
var _96=_items[_92],_97=objj_msgSend(_96,"keyEquivalentModifierMask")|(objj_msgSend(_96,"keyEquivalent")===objj_msgSend(objj_msgSend(_96,"keyEquivalent"),"uppercaseString")?CPShiftKeyMask:0);
...
p;13;CPOpenPanel.jI;16;AppKit/CPPanel.jc;2121;
...
_URLs=_1a.URLs;
console.log("the resultant URLs are "+_URLs);
return _1a.button;
}
...
p;9;CPRadio.jI;21;Foundation/CPObject.jI;18;Foundation/CPSet.ji;10;CPButton.jc;5029;
...
p;14;CPScrollView.ji;8;CPView.ji;12;CPClipView.ji;12;CPScroller.jc;16919;
...
p;13;CPTextField.ji;11;CPControl.ji;17;CPStringDrawing.ji;17;CPCompatibility.jc;19993;
...
with(_3b){
if(!objj_msgSend(_3b,"isEditable")||!objj_msgSend(_3b,"isEnabled")){
objj_msgSend(objj_msgSend(_3b,"nextResponder"),"mouseUp:",_3d);
}
}
}),new objj_method(sel_getUid("mouseDragged:"),function(_3e,_3f,_40){
with(_3e){
if(!objj_msgSend(_3e,"isEditable")||!objj_msgSend(_3e,"isEnabled")){
objj_msgSend(objj_msgSend(_3e,"nextResponder"),"mouseDragged:",_40);
}
}
}),new objj_method(sel_getUid("keyUp:"),function(_41,_42,_43){
with(_41){
var _44=objj_msgSend(_41,"stringValue");
objj_msgSend(_41,"_setStringValue:",objj_msgSend(_41,"_inputElement").value);
if(_44!==objj_msgSend(_41,"stringValue")){
if(!_isEditing){
_isEditing=YES;
objj_msgSend(_41,"textDidBeginEditing:",objj_msgSend(CPNotification,"notificationWithName:object:userInfo:",CPControlTextDidBeginEditingNotification,_41,nil));
}
...
objj_msgSend(objj_msgSend(objj_msgSend(_41,"window"),"platformWindow"),"_propagateCurrentDOMEvent:",YES);
}
}),new objj_method(sel_getUid("keyDown:"),function(_45,_46,_47){
with(_45){
if(objj_msgSend(_47,"keyCode")===CPReturnKeyCode){
if(_isEditing){
_isEditing=NO;
objj_msgSend(_45,"textDidEndEditing:",objj_msgSend(CPNotification,"notificationWithName:object:userInfo:",CPControlTextDidEndEditingNotification,_45,nil));
}
objj_msgSend(_45,"sendAction:to:",objj_msgSend(_45,"action"),objj_msgSend(_45,"target"));
objj_msgSend(_45,"selectText:",nil);
objj_msgSend(objj_msgSend(objj_msgSend(_45,"window"),"platformWindow"),"_propagateCurrentDOMEvent:",NO);
}else{
if(objj_msgSend(_47,"keyCode")===CPTabKeyCode){
if(objj_msgSend(_47,"modifierFlags")&CPShiftKeyMask){
objj_msgSend(objj_msgSend(_45,"window"),"selectPreviousKeyView:",_45);
}else{
objj_msgSend(objj_msgSend(_45,"window"),"selectNextKeyView:",_45);
}
objj_msgSend(objj_msgSend(objj_msgSend(_45,"window"),"platformWindow"),"_propagateCurrentDOMEvent:",NO);
}else{
...
}),new objj_method(sel_getUid("textDidBlur:"),function(_48,_49,_4a){
with(_48){
if(objj_msgSend(_4a,"object")!=_48){
return;
}
objj_msgSend(objj_msgSend(CPNotificationCenter,"defaultCenter"),"postNotification:",_4a);
}
}),new objj_method(sel_getUid("textDidFocus:"),function(_4b,_4c,_4d){
with(_4b){
if(objj_msgSend(_4d,"object")!=_4b){
return;
}
objj_msgSend(objj_msgSend(CPNotificationCenter,"defaultCenter"),"postNotification:",_4d);
}
}),new objj_method(sel_getUid("objectValue"),function(_4e,_4f){
with(_4e){
return objj_msgSendSuper({receiver:_4e,super_class:objj_getClass("CPControl")},"objectValue");
}
}),new objj_method(sel_getUid("_setStringValue:"),function(_50,_51,_52){
with(_50){
objj_msgSend(_50,"willChangeValueForKey:","objectValue");
objj_msgSendSuper({receiver:_50,super_class:objj_getClass("CPControl")},"setObjectValue:",String(_52));
objj_msgSend(_50,"_updatePlaceholderState");
objj_msgSend(_50,"didChangeValueForKey:","objectValue");
}
}),new objj_method(sel_getUid("setObjectValue:"),function(_53,_54,_55){
with(_53){
objj_msgSendSuper({receiver:_53,super_class:objj_getClass("CPControl")},"setObjectValue:",_55);
objj_msgSend(_53,"_updatePlaceholderState");
}
}),new objj_method(sel_getUid("_updatePlaceholderState"),function(_56,_57){
with(_56){
var _58=objj_msgSend(_56,"stringValue");
if((!_58||_58.length===0)&&!objj_msgSend(_56,"hasThemeState:",CPThemeStateEditing)){
objj_msgSend(_56,"setThemeState:",CPTextFieldStatePlaceholder);
}else{
objj_msgSend(_56,"unsetThemeState:",CPTextFieldStatePlaceholder);
}
}
}),new objj_method(sel_getUid("setPlaceholderString:"),function(_59,_5a,_5b){
with(_59){
if(_placeholderString===_5b){
return;
}
_placeholderString=_5b;
if(objj_msgSend(_59,"hasThemeState:",CPTextFieldStatePlaceholder)){
objj_msgSend(_59,"setNeedsLayout");
objj_msgSend(_59,"setNeedsDisplay:",YES);
}
}
}),new objj_method(sel_getUid("placeholderString"),function(_5c,_5d){
with(_5c){
return _placeholderString;
}
}),new objj_method(sel_getUid("sizeToFit"),function(_5e,_5f){
with(_5e){
var _60=objj_msgSend((objj_msgSend(_5e,"stringValue")||" "),"sizeWithFont:",objj_msgSend(_5e,"currentValueForThemeAttribute:","font")),_61=objj_msgSend(_5e,"currentValueForThemeAttribute:","content-inset"),_62=objj_msgSend(_5e,"currentValueForThemeAttribute:","min-size"),_63=objj_msgSend(_5e,"currentValueForThemeAttribute:","max-size");
_60.width=MAX(_60.width+_61.left+_61.right,_62.width);
_60.height=MAX(_60.height+_61.top+_61.bottom,_62.height);
if(_63.width>=0){
_60.width=MIN(_60.width,_63.width);
}
if(_63.height>=0){
_60.height=MIN(_60.height,_63.height);
}
if(objj_msgSend(_5e,"isEditable")){
_60.width=CGRectGetWidth(objj_msgSend(_5e,"frame"));
}
objj_msgSend(_5e,"setFrameSize:",_60);
}
}),new objj_method(sel_getUid("selectText:"),function(_64,_65,_66){
with(_64){
}
...
if(_delegate){
objj_msgSend(_6a,"removeObserver:name:object:",_delegate,CPControlTextDidBeginEditingNotification,_67);
objj_msgSend(_6a,"removeObserver:name:object:",_delegate,CPControlTextDidChangeNotification,_67);
objj_msgSend(_6a,"removeObserver:name:object:",_delegate,CPControlTextDidEndEditingNotification,_67);
objj_msgSend(_6a,"removeObserver:name:object:",_delegate,CPTextFieldDidFocusNotification,_67);
objj_msgSend(_6a,"removeObserver:name:object:",_delegate,CPTextFieldDidBlurNotification,_67);
}
_delegate=_69;
if(objj_msgSend(_delegate,"respondsToSelector:",sel_getUid("controlTextDidBeginEditing:"))){
objj_msgSend(_6a,"addObserver:selector:name:object:",_delegate,sel_getUid("controlTextDidBeginEditing:"),CPControlTextDidBeginEditingNotification,_67);
}
if(objj_msgSend(_delegate,"respondsToSelector:",sel_getUid("controlTextDidChange:"))){
objj_msgSend(_6a,"addObserver:selector:name:object:",_delegate,sel_getUid("controlTextDidChange:"),CPControlTextDidChangeNotification,_67);
}
if(objj_msgSend(_delegate,"respondsToSelector:",sel_getUid("controlTextDidEndEditing:"))){
objj_msgSend(_6a,"addObserver:selector:name:object:",_delegate,sel_getUid("controlTextDidEndEditing:"),CPControlTextDidEndEditingNotification,_67);
}
if(objj_msgSend(_delegate,"respondsToSelector:",sel_getUid("controlTextDidFocus:"))){
objj_msgSend(_6a,"addObserver:selector:name:object:",_delegate,sel_getUid("controlTextDidFocus:"),CPTextFieldDidFocusNotification,_67);
}
if(objj_msgSend(_delegate,"respondsToSelector:",sel_getUid("controlTextDidBlur:"))){
objj_msgSend(_6a,"addObserver:selector:name:object:",_delegate,sel_getUid("controlTextDidBlur:"),CPTextFieldDidBlurNotification,_67);
}
}
}),new objj_method(sel_getUid("delegate"),function(_6b,_6c){
with(_6b){
return _delegate;
}
}),new objj_method(sel_getUid("contentRectForBounds:"),function(_6d,_6e,_6f){
with(_6d){
var _70=objj_msgSend(_6d,"currentValueForThemeAttribute:","content-inset");
if(!_70){
return _6f;
}
_6f.origin.x+=_70.left;
_6f.origin.y+=_70.top;
_6f.size.width-=_70.left+_70.right;
_6f.size.height-=_70.top+_70.bottom;
return _6f;
}
}),new objj_method(sel_getUid("bezelRectForBounds:"),function(_71,_72,_73){
with(_71){
var _74=objj_msgSend(_71,"currentValueForThemeAttribute:","bezel-inset");
if(((_74).top===0&&(_74).right===0&&(_74).bottom===0&&(_74).left===0)){
return _73;
}
_73.origin.x+=_74.left;
_73.origin.y+=_74.top;
_73.size.width-=_74.left+_74.right;
_73.size.height-=_74.top+_74.bottom;
return _73;
}
}),new objj_method(sel_getUid("rectForEphemeralSubviewNamed:"),function(_75,_76,_77){
with(_75){
if(_77==="bezel-view"){
return objj_msgSend(_75,"bezelRectForBounds:",objj_msgSend(_75,"bounds"));
}else{
if(_77==="content-view"){
return objj_msgSend(_75,"contentRectForBounds:",objj_msgSend(_75,"bounds"));
}
}
return objj_msgSendSuper({receiver:_75,super_class:objj_getClass("CPControl")},"rectForEphemeralSubviewNamed:",_77);
}
}),new objj_method(sel_getUid("createEphemeralSubviewNamed:"),function(_78,_79,_7a){
with(_78){
if(_7a==="bezel-view"){
var _7b=objj_msgSend(objj_msgSend(CPView,"alloc"),"initWithFrame:",{origin:{x:0,y:0},size:{width:0,height:0}});
objj_msgSend(_7b,"setHitTests:",NO);
return _7b;
}else{
var _7b=objj_msgSend(objj_msgSend(_CPImageAndTextView,"alloc"),"initWithFrame:",{origin:{x:0,y:0},size:{width:0,height:0}});
return _7b;
}
return objj_msgSendSuper({receiver:_78,super_class:objj_getClass("CPControl")},"createEphemeralSubviewNamed:",_7a);
}
}),new objj_method(sel_getUid("layoutSubviews"),function(_7c,_7d){
with(_7c){
var _7e=objj_msgSend(_7c,"layoutEphemeralSubviewNamed:positioned:relativeToEphemeralSubviewNamed:","bezel-view",CPWindowBelow,"content-view");
if(_7e){
objj_msgSend(_7e,"setBackgroundColor:",objj_msgSend(_7c,"currentValueForThemeAttribute:","bezel-color"));
}
var _7f=objj_msgSend(_7c,"layoutEphemeralSubviewNamed:positioned:relativeToEphemeralSubviewNamed:","content-view",CPWindowAbove,"bezel-view");
if(_7f){
objj_msgSend(_7f,"setHidden:",objj_msgSend(_7c,"hasThemeState:",CPThemeStateEditing));
var _80="";
if(objj_msgSend(_7c,"hasThemeState:",CPTextFieldStatePlaceholder)){
_80=objj_msgSend(_7c,"placeholderString");
}else{
_80=objj_msgSend(_7c,"stringValue");
if(objj_msgSend(_7c,"isSecure")){
_80=_81(_80);
}
}
objj_msgSend(_7f,"setText:",_80);
objj_msgSend(_7f,"setTextColor:",objj_msgSend(_7c,"currentValueForThemeAttribute:","text-color"));
objj_msgSend(_7f,"setFont:",objj_msgSend(_7c,"currentValueForThemeAttribute:","font"));
objj_msgSend(_7f,"setAlignment:",objj_msgSend(_7c,"currentValueForThemeAttribute:","alignment"));
objj_msgSend(_7f,"setVerticalAlignment:",objj_msgSend(_7c,"currentValueForThemeAttribute:","vertical-alignment"));
objj_msgSend(_7f,"setLineBreakMode:",objj_msgSend(_7c,"currentValueForThemeAttribute:","line-break-mode"));
objj_msgSend(_7f,"setTextShadowColor:",objj_msgSend(_7c,"currentValueForThemeAttribute:","text-shadow-color"));
objj_msgSend(_7f,"setTextShadowOffset:",objj_msgSend(_7c,"currentValueForThemeAttribute:","text-shadow-offset"));
}
}
})]);
class_addMethods(_3,[new objj_method(sel_getUid("textFieldWithStringValue:placeholder:width:"),function(_82,_83,_84,_85,_86){
with(_82){
return objj_msgSend(_82,"textFieldWithStringValue:placeholder:width:theme:",_84,_85,_86,objj_msgSend(CPTheme,"defaultTheme"));
}
}),new objj_method(sel_getUid("textFieldWithStringValue:placeholder:width:theme:"),function(_87,_88,_89,_8a,_8b,_8c){
with(_87){
var _8d=objj_msgSend(objj_msgSend(_87,"alloc"),"initWithFrame:",CGRectMake(0,0,_8b,29));
objj_msgSend(_8d,"setTheme:",_8c);
objj_msgSend(_8d,"setStringValue:",_89);
objj_msgSend(_8d,"setPlaceholderString:",_8a);
objj_msgSend(_8d,"setBordered:",YES);
objj_msgSend(_8d,"setBezeled:",YES);
objj_msgSend(_8d,"setEditable:",YES);
objj_msgSend(_8d,"sizeToFit");
return _8d;
}
}),new objj_method(sel_getUid("roundedTextFieldWithStringValue:placeholder:width:"),function(_8e,_8f,_90,_91,_92){
with(_8e){
return objj_msgSend(_8e,"roundedTextFieldWithStringValue:placeholder:width:theme:",_90,_91,_92,objj_msgSend(CPTheme,"defaultTheme"));
}
}),new objj_method(sel_getUid("roundedTextFieldWithStringValue:placeholder:width:theme:"),function(_93,_94,_95,_96,_97,_98){
with(_93){
var _99=objj_msgSend(objj_msgSend(CPTextField,"alloc"),"initWithFrame:",CGRectMake(0,0,_97,29));
objj_msgSend(_99,"setTheme:",_98);
objj_msgSend(_99,"setStringValue:",_95);
objj_msgSend(_99,"setPlaceholderString:",_96);
objj_msgSend(_99,"setBezelStyle:",CPTextFieldRoundedBezel);
objj_msgSend(_99,"setBordered:",YES);
objj_msgSend(_99,"setBezeled:",YES);
objj_msgSend(_99,"setEditable:",YES);
objj_msgSend(_99,"sizeToFit");
return _99;
}
}),new objj_method(sel_getUid("labelWithTitle:"),function(_9a,_9b,_9c){
with(_9a){
return objj_msgSend(_9a,"labelWithTitle:theme:",_9c,objj_msgSend(CPTheme,"defaultTheme"));
}
}),new objj_method(sel_getUid("labelWithTitle:theme:"),function(_9d,_9e,_9f,_a0){
with(_9d){
var _a1=objj_msgSend(objj_msgSend(_9d,"alloc"),"init");
objj_msgSend(_a1,"setStringValue:",_9f);
objj_msgSend(_a1,"sizeToFit");
return _a1;
}
}),new objj_method(sel_getUid("themeClass"),function(_a2,_a3){
with(_a2){
return "textfield";
}
}),new objj_method(sel_getUid("themeAttributes"),function(_a4,_a5){
with(_a4){
...
var _81=function(_a6){
if(!_a6){
return "";
}
return Array(_a6.length+1).join(_1);
};
var _a7="CPTextFieldIsEditableKey",_a8="CPTextFieldIsSelectableKey",_a9="CPTextFieldIsBorderedKey",_aa="CPTextFieldIsBezeledKey",_ab="CPTextFieldBezelStyleKey",_ac="CPTextFieldDrawsBackgroundKey",_ad="CPTextFieldLineBreakModeKey",_ae="CPTextFieldBackgroundColorKey",_af="CPTextFieldPlaceholderStringKey";
...
var _3=_2.isa;
class_addMethods(_2,[new objj_method(sel_getUid("initWithCoder:"),function(_b0,_b1,_b2){
with(_b0){
_b0=objj_msgSendSuper({receiver:_b0,super_class:objj_getClass("CPControl")},"initWithCoder:",_b2);
if(_b0){
objj_msgSend(_b0,"setEditable:",objj_msgSend(_b2,"decodeBoolForKey:",_a7));
objj_msgSend(_b0,"setSelectable:",objj_msgSend(_b2,"decodeBoolForKey:",_a8));
objj_msgSend(_b0,"setDrawsBackground:",objj_msgSend(_b2,"decodeBoolForKey:",_ac));
objj_msgSend(_b0,"setTextFieldBackgroundColor:",objj_msgSend(_b2,"decodeObjectForKey:",_ae));
objj_msgSend(_b0,"setPlaceholderString:",objj_msgSend(_b2,"decodeObjectForKey:",_af));
}
return _b0;
}
}),new objj_method(sel_getUid("encodeWithCoder:"),function(_b3,_b4,_b5){
with(_b3){
objj_msgSendSuper({receiver:_b3,super_class:objj_getClass("CPControl")},"encodeWithCoder:",_b5);
objj_msgSend(_b5,"encodeBool:forKey:",_isEditable,_a7);
objj_msgSend(_b5,"encodeBool:forKey:",_isSelectable,_a8);
objj_msgSend(_b5,"encodeBool:forKey:",_drawsBackground,_ac);
objj_msgSend(_b5,"encodeObject:forKey:",_textFieldBackgroundColor,_ae);
objj_msgSend(_b5,"encodeObject:forKey:",_placeholderString,_af);
}
})]);
...
p;11;CPToolbar.jI;21;Foundation/CPObject.ji;15;CPPopUpButton.ji;15;CPToolbarItem.jc;22202;
...
}),new objj_method(sel_getUid("setEnabled:"),function(_b8,_b9,_ba){
with(_b8){
objj_msgSendSuper({receiver:_b8,super_class:objj_getClass("CPControl")},"setEnabled:",_ba);
if(_ba){
...
}),new objj_method(sel_getUid("FIXME_labelColor"),function(_bb,_bc){
with(_bb){
if(_FIXME_isHUD){
...
}),new objj_method(sel_getUid("FIXME_labelShadowColor"),function(_bd,_be){
with(_bd){
if(_FIXME_isHUD){
return objj_msgSend(_bd,"isHighlighted")?objj_msgSend(CPColor,"colorWithWhite:alpha:",1,0.5):objj_msgSend(CPColor,"clearColor");
}
return objj_msgSend(_bd,"isHighlighted")?objj_msgSend(CPColor,"colorWithWhite:alpha:",0,0.3):objj_msgSend(CPColor,"colorWithWhite:alpha:",1,0.75);
}
}),new objj_method(sel_getUid("setHighlighted:"),function(_bf,_c0,_c1){
with(_bf){
objj_msgSendSuper({receiver:_bf,super_class:objj_getClass("CPControl")},"setHighlighted:",_c1);
if(_c1){
var _c2=objj_msgSend(_toolbarItem,"alternateImage");
if(_c2){
objj_msgSend(_imageView,"setImage:",_c2);
}
objj_msgSend(_labelField,"setTextShadowOffset:",CGSizeMakeZero());
}else{
var _c3=objj_msgSend(_toolbarItem,"image");
if(_c3){
objj_msgSend(_imageView,"setImage:",_c3);
}
objj_msgSend(_labelField,"setTextShadowOffset:",CGSizeMake(0,1));
}
objj_msgSend(_labelField,"setTextShadowColor:",objj_msgSend(_bf,"FIXME_labelShadowColor"));
}
}),new objj_method(sel_getUid("observeValueForKeyPath:ofObject:change:context:"),function(_c4,_c5,_c6,_c7,_c8,_c9){
with(_c4){
if(_c6==="enabled"){
objj_msgSend(_c4,"setEnabled:",objj_msgSend(_c7,"isEnabled"));
}
}
})]);
p;15;CPToolbarItem.jI;21;Foundation/CPObject.jI;21;Foundation/CPString.jI;16;AppKit/CPImage.jI;15;AppKit/CPView.jc;10071;
...
var _2=_1.isa;
class_addMethods(_1,[new objj_method(sel_getUid("copy"),function(_57,_58){
with(_57){
var _59=objj_msgSend(objj_msgSend(objj_msgSend(_57,"class"),"alloc"),"initWithItemIdentifier:",_itemIdentifier);
if(_view){
objj_msgSend(_59,"setView:",objj_msgSend(CPKeyedUnarchiver,"unarchiveObjectWithData:",objj_msgSend(CPKeyedArchiver,"archivedDataWithRootObject:",_view)));
}
objj_msgSend(_59,"setLabel:",_label);
objj_msgSend(_59,"setPaletteLabel:",_paletteLabel);
objj_msgSend(_59,"setToolTip:",objj_msgSend(_57,"toolTip"));
objj_msgSend(_59,"setTag:",objj_msgSend(_57,"tag"));
objj_msgSend(_59,"setTarget:",objj_msgSend(_57,"target"));
objj_msgSend(_59,"setAction:",objj_msgSend(_57,"action"));
objj_msgSend(_59,"setEnabled:",objj_msgSend(_57,"isEnabled"));
objj_msgSend(_59,"setImage:",objj_msgSend(_57,"image"));
objj_msgSend(_59,"setAlternateImage:",objj_msgSend(_57,"alternateImage"));
objj_msgSend(_59,"setMinSize:",_minSize);
objj_msgSend(_59,"setMaxSize:",_maxSize);
objj_msgSend(_59,"setVisibilityPriority:",_visibilityPriority);
return _59;
}
})]);
var _1=objj_getClass("CPToolbarItem");
...
var _2=_1.isa;
class_addMethods(_2,[new objj_method(sel_getUid("_standardItemWithItemIdentifier:"),function(_5a,_5b,_5c){
with(_5a){
var _5d=objj_msgSend(objj_msgSend(CPToolbarItem,"alloc"),"initWithItemIdentifier:",_5c);
switch(_5c){
case CPToolbarSeparatorItemIdentifier:
objj_msgSend(_5d,"setMinSize:",CGSizeMake(2,0));
objj_msgSend(_5d,"setMaxSize:",CGSizeMake(2,100000));
return _5d;
case CPToolbarSpaceItemIdentifier:
objj_msgSend(_5d,"setMinSize:",CGSizeMake(32,32));
objj_msgSend(_5d,"setMaxSize:",CGSizeMake(32,32));
return _5d;
case CPToolbarFlexibleSpaceItemIdentifier:
objj_msgSend(_5d,"setMinSize:",CGSizeMake(32,32));
objj_msgSend(_5d,"setMaxSize:",CGSizeMake(10000,32));
return _5d;
...
p;12;CPTreeNode.jI;21;Foundation/CPObject.jc;2406;
...
p;20;CPWindowController.jI;21;Foundation/CPObject.jI;21;Foundation/CPString.ji;13;CPResponder.ji;10;CPWindow.ji;12;CPDocument.jc;9146;
...
with(_58){
objj_msgSend(objj_msgSend(_58,"window"),"setDocumentEdited:",_5a);
}
}),new objj_method(sel_getUid("close"),function(_5b,_5c){
with(_5b){
objj_msgSend(objj_msgSend(_5b,"window"),"close");
}
}),new objj_method(sel_getUid("setShouldCloseDocument:"),function(_5d,_5e,_5f){
with(_5d){
_shouldCloseDocument=_5f;
}
}),new objj_method(sel_getUid("shouldCloseDocument"),function(_60,_61){
with(_60){
return _shouldCloseDocument;
}
}),new objj_method(sel_getUid("owner"),function(_62,_63){
with(_62){
return _cibOwner;
}
}),new objj_method(sel_getUid("windowCibName"),function(_64,_65){
with(_64){
if(_windowCibName){
...
}),new objj_method(sel_getUid("windowCibPath"),function(_66,_67){
with(_66){
if(_windowCibPath){
...
}),new objj_method(sel_getUid("synchronizeWindowTitleWithDocumentName"),function(_68,_69){
with(_68){
if(!_document||!_window){
return;
}
objj_msgSend(_window,"setTitle:",objj_msgSend(_68,"windowTitleForDocumentDisplayName:",objj_msgSend(_document,"displayName")));
}
}),new objj_method(sel_getUid("windowTitleForDocumentDisplayName:"),function(_6a,_6b,_6c){
with(_6a){
return _6c;
}
})]);
...
p;15;_CPWindowView.ji;8;CPView.ji;13;CPImageView.jc;9036;
var _1=nil;
...
objj_msgSend(_5a,"FIXME_setIsHUD:",_styleMask&CPHUDBackgroundWindowMask);
...
p;10;CPWindow.jI;25;Foundation/CPCountedSet.jI;33;Foundation/CPNotificationCenter.jI;26;Foundation/CPUndoManager.ji;12;CGGeometry.ji;13;CPAnimation.ji;13;CPResponder.ji;10;CPScreen.ji;18;CPPlatformWindow.jc;53063;
...
objj_msgSend(_b,"setShowsResizeIndicator:",_styleMask&CPResizableWindowMask);
}
return _b;
}
...
objj_msgSend(_windowView,"setShowsResizeIndicator:",objj_msgSend(_17,"showsResizeIndicator"));
...
with(_2d){
var _32=_2f.origin.x,_33=_32-FLOOR(_32);
if(_33){
_2f.origin.x=_32>0.879?CEIL(_32):FLOOR(_32);
}
_32=_2f.origin.y;
_33=_32-FLOOR(_32);
if(_33){
_2f.origin.y=_32>0.879?CEIL(_32):FLOOR(_32);
}
_32=_2f.size.width;
_33=_32-FLOOR(_32);
if(_33){
_2f.size.width=_32>0.15?CEIL(_32):FLOOR(_32);
}
_32=_2f.size.height;
_33=_32-FLOOR(_32);
if(_33){
_2f.size.height=_32>0.15?CEIL(_32):FLOOR(_32);
}
if(_31){
var _34=objj_msgSend(objj_msgSend(_CPWindowFrameAnimation,"alloc"),"initWithWindow:targetFrame:",_2d,_2f);
objj_msgSend(_34,"startAnimation");
}else{
var _35=_frame.origin,_36=_2f.origin;
if(!(_35.x==_36.x&&_35.y==_36.y)){
_35.x=_36.x;
_35.y=_36.y;
objj_msgSend(objj_msgSend(CPNotificationCenter,"defaultCenter"),"postNotificationName:object:",CPWindowDidMoveNotification,_2d);
}
var _37=_frame.size,_38=_2f.size;
...
with(_5c){
_5e=!!_5e;
if(_showsResizeIndicator===_5e){
return;
}
_showsResizeIndicator=_5e;
objj_msgSend(_windowView,"setShowsResizeIndicator:",objj_msgSend(_5c,"showsResizeIndicator"));
}
...
}),new objj_method(sel_getUid("_updateShadow"),function(_7f,_80){
with(_7f){
...
var _81=objj_msgSend(_windowView,"bounds");
_shadowView=objj_msgSend(objj_msgSend(CPView,"alloc"),"initWithFrame:",CGRectMake(-_1,-_3+_5,_1+CGRectGetWidth(_81)+_2,_3+CGRectGetHeight(_81)+_4));
if(!_6){
var _82=objj_msgSend(CPBundle,"bundleForClass:",objj_msgSend(CPWindow,"class"));
_6=objj_msgSend(CPColor,"colorWithPatternImage:",objj_msgSend(objj_msgSend(CPNinePartImage,"alloc"),"initWithImageSlices:",[objj_msgSend(objj_msgSend(CPImage,"alloc"),"initWithContentsOfFile:size:",objj_msgSend(_82,"pathForResource:","CPWindow/CPWindowShadow0.png"),CGSizeMake(20,19)),objj_msgSend(objj_msgSend(CPImage,"alloc"),"initWithContentsOfFile:size:",objj_msgSend(_82,"pathForResource:","CPWindow/CPWindowShadow1.png"),CGSizeMake(1,19)),objj_msgSend(objj_msgSend(CPImage,"alloc"),"initWithContentsOfFile:size:",objj_msgSend(_82,"pathForResource:","CPWindow/CPWindowShadow2.png"),CGSizeMake(19,19)),objj_msgSend(objj_msgSend(CPImage,"alloc"),"initWithContentsOfFile:size:",objj_msgSend(_82,"pathForResource:","CPWindow/CPWindowShadow3.png"),CGSizeMake(20,1)),objj_msgSend(objj_msgSend(CPImage,"alloc"),"initWithContentsOfFile:size:",objj_msgSend(_82,"pathForResource:","CPWindow/CPWindowShadow4.png"),CGSizeMake(1,1)),objj_msgSend(objj_msgSend(CPImage,"alloc"),"initWithContentsOfFile:size:",objj_msgSend(_82,"pathForResource:","CPWindow/CPWindowShadow5.png"),CGSizeMake(19,1)),objj_msgSend(objj_msgSend(CPImage,"alloc"),"initWithContentsOfFile:size:",objj_msgSend(_82,"pathForResource:","CPWindow/CPWindowShadow6.png"),CGSizeMake(20,18)),objj_msgSend(objj_msgSend(CPImage,"alloc"),"initWithContentsOfFile:size:",objj_msgSend(_82,"pathForResource:","CPWindow/CPWindowShadow7.png"),CGSizeMake(1,18)),objj_msgSend(objj_msgSend(CPImage,"alloc"),"initWithContentsOfFile:size:",objj_msgSend(_82,"pathForResource:","CPWindow/CPWindowShadow8.png"),CGSizeMake(19,18))]));
}
...
}),new objj_method(sel_getUid("setHasShadow:"),function(_83,_84,_85){
with(_83){
if(_hasShadow===_85){
return;
}
_hasShadow=_85;
objj_msgSend(_83,"_updateShadow");
}
}),new objj_method(sel_getUid("setShadowStyle:"),function(_86,_87,_88){
with(_86){
_shadowStyle=_88;
objj_msgSend(objj_msgSend(_86,"platformWindow"),"setShadowStyle:",_shadowStyle);
}
...
}),new objj_method(sel_getUid("setDocumentEdited:"),function(self,_100,_101){
with(self){
if(_isDocumentEdited==_101){
return;
}
_isDocumentEdited=_101;
objj_msgSend(CPMenu,"_setMenuBarIconImageAlphaValue:",_isDocumentEdited?0.5:1);
objj_msgSend(_windowView,"setDocumentEdited:",_101);
}
}),new objj_method(sel_getUid("isDocumentEdited"),function(self,_102){
with(self){
return _isDocumentEdited;
}
}),new objj_method(sel_getUid("setDocumentSaving:"),function(self,_103,_104){
with(self){
if(_isDocumentSaving==_104){
return;
}
_isDocumentSaving=_104;
objj_msgSend(self,"_synchronizeSaveMenuWithDocumentSaving");
objj_msgSend(_windowView,"windowDidChangeDocumentSaving");
}
}),new objj_method(sel_getUid("isDocumentSaving"),function(self,_105){
with(self){
return _isDocumentSaving;
}
}),new objj_method(sel_getUid("_synchronizeSaveMenuWithDocumentSaving"),function(self,_106){
with(self){
if(!objj_msgSend(self,"isMainWindow")){
return;
}
var _107=objj_msgSend(CPApp,"mainMenu"),_108=objj_msgSend(_107,"indexOfItemWithTitle:",_isDocumentSaving?"Save":"Saving...");
if(_108==CPNotFound){
return;
}
var item=objj_msgSend(_107,"itemAtIndex:",_108);
...
}),new objj_method(sel_getUid("performMiniaturize:"),function(self,_109,_10a){
with(self){
objj_msgSend(self,"miniaturize:",_10a);
}
}),new objj_method(sel_getUid("miniaturize:"),function(self,_10b,_10c){
with(self){
...
objj_msgSend(objj_msgSend(self,"platformWindow"),"miniaturize:",_10c);
...
}),new objj_method(sel_getUid("deminiaturize:"),function(self,_10d,_10e){
with(self){
objj_msgSend(objj_msgSend(self,"platformWindow"),"deminiaturize:",_10e);
...
}),new objj_method(sel_getUid("isMiniaturized"),function(self,_10f){
with(self){
return _isMiniaturized;
}
}),new objj_method(sel_getUid("performClose:"),function(self,_110,_111){
with(self){
if(!(_styleMask&CPClosableWindowMask)){
return;
}
...
var _112=objj_msgSend(_windowController,"documents");
if(objj_msgSend(_112,"count")){
var _113=objj_msgSend(_112,"indexOfObject:",objj_msgSend(_windowController,"document"));
objj_msgSend(_112[_113],"shouldCloseWindowController:delegate:shouldCloseSelector:contextInfo:",_windowController,self,sel_getUid("_windowControllerContainingDocument:shouldClose:contextInfo:"),{documents:objj_msgSend(_112,"copy"),visited:0,index:_113});
}else{
objj_msgSend(self,"close");
}
}
}),new objj_method(sel_getUid("_windowControllerContainingDocument:shouldClose:contextInfo:"),function(self,_114,_115,_116,_117){
with(self){
if(_116){
var _118=objj_msgSend(self,"windowController"),_119=_117.documents,_11a=objj_msgSend(_119,"count"),_11b=++_117.visited,_11c=++_117.index%_11a;
objj_msgSend(_115,"removeWindowController:",_118);
if(_11b<_11a){
objj_msgSend(_118,"setDocument:",_119[_11c]);
objj_msgSend(_119[_11c],"shouldCloseWindowController:delegate:shouldCloseSelector:contextInfo:",_windowController,self,sel_getUid("_windowControllerContainingDocument:shouldClose:contextInfo:"),_117);
}else{
objj_msgSend(self,"close");
}
}
}
}),new objj_method(sel_getUid("close"),function(self,_11d){
with(self){
...
}),new objj_method(sel_getUid("isMainWindow"),function(self,_11e){
with(self){
return objj_msgSend(CPApp,"mainWindow")==self;
}
}),new objj_method(sel_getUid("canBecomeMainWindow"),function(self,_11f){
with(self){
...
}),new objj_method(sel_getUid("makeMainWindow"),function(self,_120){
with(self){
...
}),new objj_method(sel_getUid("becomeMainWindow"),function(self,_121){
with(self){
...
}),new objj_method(sel_getUid("resignMainWindow"),function(self,_122){
with(self){
...
}),new objj_method(sel_getUid("toolbar"),function(self,_123){
with(self){
return _toolbar;
}
}),new objj_method(sel_getUid("setToolbar:"),function(self,_124,_125){
with(self){
if(_toolbar===_125){
return;
}
...
}),new objj_method(sel_getUid("toggleToolbarShown:"),function(self,_126,_127){
with(self){
var _128=objj_msgSend(self,"toolbar");
objj_msgSend(_128,"setVisible:",!objj_msgSend(_128,"isVisible"));
}
}),new objj_method(sel_getUid("_noteToolbarChanged"),function(self,_129){
with(self){
...
}),new objj_method(sel_getUid("_setFrame:delegate:duration:curve:"),function(self,_12c,_12d,_12e,_12f,_130){
with(self){
var _131=objj_msgSend(objj_msgSend(_CPWindowFrameAnimation,"alloc"),"initWithWindow:targetFrame:",self,_12d);
objj_msgSend(_131,"setDelegate:",_12e);
objj_msgSend(_131,"setAnimationCurve:",_130);
objj_msgSend(_131,"setDuration:",_12f);
objj_msgSend(_131,"startAnimation");
}
}),new objj_method(sel_getUid("_setAttachedSheetFrameOrigin"),function(self,_132){
with(self){
var _133=objj_msgSend(self,"attachedSheet");
var _134=objj_msgSend(objj_msgSend(self,"contentView"),"frame"),_135=CGRectMakeCopy(objj_msgSend(_133,"frame"));
_135.origin.y=CGRectGetMinY(_frame)+CGRectGetMinY(_134);
_135.origin.x=CGRectGetMinX(_frame)+FLOOR((CGRectGetWidth(_frame)-CGRectGetWidth(_135))/2);
objj_msgSend(_133,"setFrameOrigin:",_135.origin);
}
}),new objj_method(sel_getUid("_attachSheet:modalDelegate:didEndSelector:contextInfo:"),function(self,_136,_137,_138,_139,_13a){
with(self){
var _13b=objj_msgSend(_137,"frame");
_sheetContext={"sheet":_137,"modalDelegate":_138,"endSelector":_139,"contextInfo":_13a,"frame":CGRectMakeCopy(_13b),"returnCode":-1,"opened":NO};
objj_msgSend(self,"_attachSheetWindow:",_137);
}
}),new objj_method(sel_getUid("_attachSheetWindow:"),function(self,_13c,_13d){
with(self){
var _13e=objj_msgSend(_13d,"frame"),_13f=objj_msgSend(self,"frame"),_140=objj_msgSend(_13d,"contentView");
objj_msgSend(self,"_setUpMasksForView:",_140);
_13d._isSheet=YES;
_13d._parentView=self;
var _141=_13f.origin.x+FLOOR((_13f.size.width-_13e.size.width)/2),_142=_13f.origin.y+objj_msgSend(objj_msgSend(self,"contentView"),"frame").origin.y,_143=CGRectMake(_141,_142,_13e.size.width,0),_144=CGRectMake(_141,_142,_13e.size.width,_13e.size.height);
...
objj_msgSend(CPApp,"runModalForWindow:",_13d);
objj_msgSend(_13d,"orderFront:",self);
objj_msgSend(_13d,"setFrame:",_143);
_sheetContext["opened"]=YES;
objj_msgSend(_13d,"_setFrame:delegate:duration:curve:",_144,self,0.2,CPAnimationEaseOut);
objj_msgSend(_13d,"becomeKeyWindow");
}
}),new objj_method(sel_getUid("_detachSheetWindow"),function(self,_145){
with(self){
var _146=objj_msgSend(self,"attachedSheet"),_147=objj_msgSend(_146,"frame"),_148=CGRectMakeCopy(_147);
_148.size.height=0;
_sheetContext["frame"]=_147;
var _149=objj_msgSend(_146,"contentView");
objj_msgSend(self,"_setUpMasksForView:",_149);
_sheetContext["opened"]=NO;
objj_msgSend(_146,"_setFrame:delegate:duration:curve:",_148,self,0.2,CPAnimationEaseIn);
}
}),new objj_method(sel_getUid("animationDidEnd:"),function(self,_14a,anim){
with(self){
var _14b=_sheetContext["sheet"];
if(anim._window!=_14b){
return;
}
var _14c=objj_msgSend(_14b,"contentView");
if(_sheetContext["opened"]===YES){
objj_msgSend(self,"_restoreMasksForView:",_14c);
return;
}
...
objj_msgSend(_14b,"orderOut:",self);
var _14d=_sheetContext["frame"];
objj_msgSend(_14b,"setFrame:",_14d);
objj_msgSend(self,"_restoreMasksForView:",_14c);
var _14e=_sheetContext["modalDelegate"],_14f=_sheetContext["endSelector"];
if(_14e!=nil&&_14f!=nil){
objj_msgSend(_14e,_14f,_14b,_sheetContext["returnCode"],_sheetContext["contextInfo"]);
}
_sheetContext=nil;
_14b._parentView=nil;
}
}),new objj_method(sel_getUid("_setUpMasksForView:"),function(self,_150,_151){
with(self){
var _152=objj_msgSend(CPArray,"arrayWithArray:",objj_msgSend(_151,"subviews"));
objj_msgSend(_152,"addObject:",_151);
for(var i=0,_153=objj_msgSend(_152,"count");i<_153;i++){
var view=objj_msgSend(_152,"objectAtIndex:",i),mask=objj_msgSend(view,"autoresizingMask"),_154=(mask&CPViewMinYMargin)?128:CPViewMinYMargin;
objj_msgSend(view,"setAutoresizingMask:",(mask|_154));
}
}
}),new objj_method(sel_getUid("_restoreMasksForView:"),function(self,_155,_156){
with(self){
var _157=objj_msgSend(CPArray,"arrayWithArray:",objj_msgSend(_156,"subviews"));
objj_msgSend(_157,"addObject:",_156);
for(var i=0,_158=objj_msgSend(_157,"count");i<_158;i++){
var view=objj_msgSend(_157,"objectAtIndex:",i),mask=objj_msgSend(view,"autoresizingMask"),_159=(mask&128)?128:CPViewMinYMargin;
objj_msgSend(view,"setAutoresizingMask:",(mask&(~_159)));
}
}
}),new objj_method(sel_getUid("attachedSheet"),function(self,_15a){
with(self){
...
}),new objj_method(sel_getUid("isSheet"),function(self,_15b){
with(self){
return _isSheet;
}
}),new objj_method(sel_getUid("becomesKeyOnlyIfNeeded"),function(self,_15c){
with(self){
return NO;
}
}),new objj_method(sel_getUid("worksWhenModal"),function(self,_15d){
with(self){
return NO;
}
}),new objj_method(sel_getUid("performKeyEquivalent:"),function(self,_15e,_15f){
with(self){
return objj_msgSend(objj_msgSend(self,"contentView"),"performKeyEquivalent:",_15f);
}
}),new objj_method(sel_getUid("keyDown:"),function(self,_160,_161){
with(self){
if(!objj_msgSend(_161,"_couldBeKeyEquivalent")||!objj_msgSend(self,"performKeyEquivalent:",_161)){
objj_msgSend(self,"interpretKeyEvents:",[_161]);
}
}
}),new objj_method(sel_getUid("insertNewline:"),function(self,_162,_163){
with(self){
if(_defaultButton&&_defaultButtonEnabled){
objj_msgSend(_defaultButton,"performClick:",nil);
}
}
}),new objj_method(sel_getUid("insertTab:"),function(self,_164,_165){
with(self){
objj_msgSend(self,"selectNextKeyView:",nil);
}
}),new objj_method(sel_getUid("_dirtyKeyViewLoop"),function(self,_166){
with(self){
if(_autorecalculatesKeyViewLoop){
_keyViewLoopIsDirty=YES;
}
}
}),new objj_method(sel_getUid("_hasKeyViewLoop"),function(self,_167){
with(self){
var _168=[];
objj_msgSend(self,"_appendSubviewsOf:toArray:",_contentView,_168);
for(var i=0,_169=objj_msgSend(_168,"count");i<_169;i++){
if(_168[i]._nextKeyView){
return YES;
}
}
return NO;
}
}),new objj_method(sel_getUid("recalculateKeyViewLoop"),function(self,_16a){
with(self){
var _16b=[];
objj_msgSend(self,"_appendSubviewsOf:toArray:",_contentView,_16b);
var _16c=objj_msgSend(_16b,"sortedArrayUsingFunction:context:",_16d,_contentView),_16e=objj_msgSend(_16c,"count");
for(var i=0;i<_16e;i++){
objj_msgSend(_16c[i],"setNextKeyView:",_16c[(i+1)%_16e]);
}
_keyViewLoopIsDirty=NO;
}
}),new objj_method(sel_getUid("_appendSubviewsOf:toArray:"),function(self,_16f,_170,_171){
with(self){
var _172=objj_msgSend(_170,"subviews"),_173=objj_msgSend(_172,"count");
while(_173--){
objj_msgSend(self,"_appendSubviewsOf:toArray:",_172[_173],_171);
}
objj_msgSend(_171,"addObject:",_170);
}
}),new objj_method(sel_getUid("setAutorecalculatesKeyViewLoop:"),function(self,_174,_175){
with(self){
if(_autorecalculatesKeyViewLoop===_175){
return;
}
_autorecalculatesKeyViewLoop=_175;
...
}),new objj_method(sel_getUid("autorecalculatesKeyViewLoop"),function(self,_176){
with(self){
return _autorecalculatesKeyViewLoop;
}
}),new objj_method(sel_getUid("selectNextKeyView:"),function(self,_177,_178){
with(self){
...
}),new objj_method(sel_getUid("selectPreviousKeyView:"),function(self,_179,_17a){
with(self){
if(objj_msgSend(_firstResponder,"isKindOfClass:",objj_msgSend(CPView,"class"))){
objj_msgSend(self,"selectKeyViewPrecedingView:",_firstResponder);
}
}
}),new objj_method(sel_getUid("selectKeyViewFollowingView:"),function(self,_17b,_17c){
with(self){
if(_keyViewLoopIsDirty){
objj_msgSend(self,"recalculateKeyViewLoop");
}
objj_msgSend(self,"makeFirstResponder:",objj_msgSend(_17c,"nextValidKeyView"));
}
}),new objj_method(sel_getUid("selectKeyViewPrecedingView:"),function(self,_17d,_17e){
with(self){
if(_keyViewLoopIsDirty){
objj_msgSend(self,"recalculateKeyViewLoop");
}
objj_msgSend(self,"makeFirstResponder:",objj_msgSend(_17e,"previousValidKeyView"));
}
}),new objj_method(sel_getUid("setDefaultButtonCell:"),function(self,_17f,_180){
with(self){
objj_msgSend(self,"setDefaultButton:",_180);
}
}),new objj_method(sel_getUid("defaultButtonCell"),function(self,_181){
with(self){
return objj_msgSend(self,"defaultButton");
}
}),new objj_method(sel_getUid("setDefaultButton:"),function(self,_182,_183){
with(self){
objj_msgSend(_defaultButton,"setDefaultButton:",NO);
_defaultButton=_183;
objj_msgSend(_defaultButton,"setDefaultButton:",YES);
}
}),new objj_method(sel_getUid("defaultButton"),function(self,_184){
with(self){
return _defaultButton;
}
}),new objj_method(sel_getUid("enableKeyEquivalentForDefaultButton"),function(self,_185){
with(self){
_defaultButtonEnabled=YES;
}
}),new objj_method(sel_getUid("enableKeyEquivalentForDefaultButtonCell"),function(self,_186){
with(self){
objj_msgSend(self,"enableKeyEquivalentForDefaultButton");
}
}),new objj_method(sel_getUid("disableKeyEquivalentForDefaultButton"),function(self,_187){
with(self){
_defaultButtonEnabled=NO;
}
}),new objj_method(sel_getUid("disableKeyEquivalentForDefaultButtonCell"),function(self,_188){
with(self){
objj_msgSend(self,"disableKeyEquivalentForDefaultButton");
}
})]);
class_addMethods(_a,[new objj_method(sel_getUid("initialize"),function(self,_189){
with(self){
if(self!=objj_msgSend(CPWindow,"class")){
return;
}
var _18a=objj_msgSend(CPBundle,"bundleForClass:",objj_msgSend(CPWindow,"class"));
_8=objj_msgSend(objj_msgSend(CPImage,"alloc"),"initWithContentsOfFile:size:",objj_msgSend(_18a,"pathForResource:","CPProgressIndicator/CPProgressIndicatorSpinningStyleRegular.gif"),CGSizeMake(16,16));
}
}),new objj_method(sel_getUid("_windowViewClassForStyleMask:"),function(self,_18b,_18c){
with(self){
if(_18c&CPHUDBackgroundWindowMask){
return _CPHUDWindowView;
}else{
if(_18c===CPBorderlessWindowMask){
return _CPBorderlessWindowView;
}else{
if(_18c&CPDocModalWindowMask){
...
}),new objj_method(sel_getUid("_windowViewClassForFullPlatformWindowStyleMask:"),function(self,_18d,_18e){
with(self){
return _CPBorderlessBridgeWindowView;
}
}),new objj_method(sel_getUid("frameRectForContentRect:styleMask:"),function(self,_18f,_190,_191){
with(self){
return objj_msgSend(objj_msgSend(objj_msgSend(self,"class"),"_windowViewClassForStyleMask:",_191),"frameRectForContentRect:",_190);
}
})]);
var _16d=function(a,b,_192){
var _193=objj_msgSend(a,"convertRect:toView:",objj_msgSend(a,"bounds"),nil),_194=objj_msgSend(b,"convertRect:toView:",objj_msgSend(b,"bounds"),nil);
if(CGRectGetMinY(_193)<CGRectGetMinY(_194)){
return -1;
}else{
if(CGRectGetMinY(_193)==CGRectGetMinY(_194)&&CGRectGetMinX(_193)<CGRectGetMinX(_194)){
return -1;
}else{
if(CGRectGetMinX(_193)==CGRectGetMinX(_194)&&CGRectGetMinX(_193)==CGRectGetMinX(_194)){
return 0;
}else{
return 1;
}
...
var _a=_9.isa;
class_addMethods(_9,[new objj_method(sel_getUid("_synchronizeMenuBarTitleWithWindowTitle"),function(self,_195){
with(self){
...
var _a=_9.isa;
class_addMethods(_9,[new objj_method(sel_getUid("resizeWithOldPlatformWindowSize:"),function(self,_196,_197){
with(self){
...
var _198=objj_msgSend(_platformWindow,"contentBounds"),_199=CGRectMakeCopy(_frame),dX=(CGRectGetWidth(_198)-_197.width)/(((_autoresizingMask&CPWindowMinXMargin)?1:0)+(_autoresizingMask&CPWindowWidthSizable?1:0)+(_autoresizingMask&CPWindowMaxXMargin?1:0)),dY=(CGRectGetHeight(_198)-_197.height)/((_autoresizingMask&CPWindowMinYMargin?1:0)+(_autoresizingMask&CPWindowHeightSizable?1:0)+(_autoresizingMask&CPWindowMaxYMargin?1:0));
...
objj_msgSend(self,"setFrame:",_199);
}
}),new objj_method(sel_getUid("setAutoresizingMask:"),function(self,_19a,_19b){
with(self){
_autoresizingMask=_19b;
}
}),new objj_method(sel_getUid("autoresizingMask"),function(self,_19c){
with(self){
return _autoresizingMask;
}
}),new objj_method(sel_getUid("convertBaseToGlobal:"),function(self,_19d,_19e){
with(self){
return objj_msgSend(CPPlatform,"isBrowser")?objj_msgSend(self,"convertBaseToPlatformWindow:",_19e):objj_msgSend(self,"convertBaseToScreen:",_19e);
}
}),new objj_method(sel_getUid("convertGlobalToBase:"),function(self,_19f,_1a0){
with(self){
return objj_msgSend(CPPlatform,"isBrowser")?objj_msgSend(self,"convertPlatformWindowToBase:",_1a0):objj_msgSend(self,"convertScreenToBase:",_1a0);
}
}),new objj_method(sel_getUid("convertBaseToPlatformWindow:"),function(self,_1a1,_1a2){
with(self){
if(objj_msgSend(self,"_sharesChromeWithPlatformWindow")){
return _1a2;
}
var _1a3=objj_msgSend(self,"frame").origin;
return {x:_1a2.x+_1a3.x,y:_1a2.y+_1a3.y};
}
}),new objj_method(sel_getUid("convertPlatformWindowToBase:"),function(self,_1a4,_1a5){
with(self){
if(objj_msgSend(self,"_sharesChromeWithPlatformWindow")){
return _1a5;
}
...
}),new objj_method(sel_getUid("convertScreenToBase:"),function(self,_1a7,_1a8){
with(self){
return objj_msgSend(self,"convertPlatformWindowToBase:",objj_msgSend(_platformWindow,"convertScreenToBase:",_1a8));
}
}),new objj_method(sel_getUid("convertBaseToScreen:"),function(self,_1a9,_1aa){
with(self){
return objj_msgSend(_platformWindow,"convertBaseToScreen:",objj_msgSend(self,"convertBaseToPlatformWindow:",_1aa));
}
}),new objj_method(sel_getUid("_setSharesChromeWithPlatformWindow:"),function(self,_1ab,_1ac){
with(self){
if(_1ac&&objj_msgSend(CPPlatform,"isBrowser")){
return;
}
_sharesChromeWithPlatformWindow=_1ac;
objj_msgSend(self,"_updateShadow");
}
}),new objj_method(sel_getUid("_sharesChromeWithPlatformWindow"),function(self,_1ad){
with(self){
return _sharesChromeWithPlatformWindow;
}
}),new objj_method(sel_getUid("undoManager"),function(self,_1ae){
with(self){
...
}),new objj_method(sel_getUid("undo:"),function(self,_1af,_1b0){
with(self){
objj_msgSend(objj_msgSend(self,"undoManager"),"undo");
}
}),new objj_method(sel_getUid("redo:"),function(self,_1b1,_1b2){
with(self){
objj_msgSend(objj_msgSend(self,"undoManager"),"redo");
}
}),new objj_method(sel_getUid("containsPoint:"),function(self,_1b3,_1b4){
with(self){
...
var _a=_9.isa;
class_addMethods(_9,[new objj_method(sel_getUid("setFullBridge:"),function(self,_1b5,_1b6){
with(self){
objj_msgSend(self,"setFullPlatformWindow:",_1b6);
}
}),new objj_method(sel_getUid("isFullBridge"),function(self,_1b7){
with(self){
return objj_msgSend(self,"isFullPlatformWindow");
}
}),new objj_method(sel_getUid("convertBaseToBridge:"),function(self,_1b8,_1b9){
with(self){
return objj_msgSend(self,"convertBaseToPlatformWindow:",_1b9);
}
}),new objj_method(sel_getUid("convertBridgeToBase:"),function(self,_1ba,_1bb){
with(self){
return objj_msgSend(self,"convertPlatformWindowToBase:",_1bb);
}
})]);
var _1bc=function(_1bd,_1be,_1bf){
return _1bd+(_1be-_1bd)*_1bf;
};
...
objj_registerClassPair(_9);
objj_addClassForBundle(_9,objj_getBundleWithPath(OBJJ_CURRENT_BUNDLE.path));
class_addMethods(_9,[new objj_method(sel_getUid("initWithWindow:targetFrame:"),function(self,_1c0,_1c1,_1c2){
with(self){
...
if(self){
_window=_1c1;
_targetFrame=CGRectMakeCopy(_1c2);
_startFrame=CGRectMakeCopy(objj_msgSend(_window,"frame"));
}
return self;
}
}),new objj_method(sel_getUid("startAnimation"),function(self,_1c3){
with(self){
objj_msgSendSuper({receiver:self,super_class:objj_getClass("CPAnimation")},"startAnimation");
_window._isAnimating=YES;
}
}),new objj_method(sel_getUid("setCurrentProgress:"),function(self,_1c4,_1c5){
with(self){
objj_msgSendSuper({receiver:self,super_class:objj_getClass("CPAnimation")},"setCurrentProgress:",_1c5);
var _1c6=objj_msgSend(self,"currentValue");
if(_1c6==1){
_window._isAnimating=NO;
}
objj_msgSend(_window,"setFrameOrigin:",CGPointMake(_1bc(CGRectGetMinX(_startFrame),CGRectGetMinX(_targetFrame),_1c6),_1bc(CGRectGetMinY(_startFrame),CGRectGetMinY(_targetFrame),_1c6)));
objj_msgSend(_window,"setFrameSize:",CGSizeMake(_1bc(CGRectGetWidth(_startFrame),CGRectGetWidth(_targetFrame),_1c6),_1bc(CGRectGetHeight(_startFrame),CGRectGetHeight(_targetFrame),_1c6)));
}
})]);
_CPWindowFullPlatformWindowSessionMake=function(_1c7,_1c8,_1c9,_1ca){
return {windowView:_1c7,contentRect:_1c8,hasShadow:_1c9,level:_1ca};
};
...
p;22;CPPlatformWindow+DOM.jI;21;Foundation/CPObject.jI;22;Foundation/CPRunLoop.ji;9;CPEvent.ji;17;CPCompatibility.ji;18;CPDOMWindowLayer.ji;12;CPPlatform.ji;18;CPPlatformWindow.jc;24223;
...
var _11,_12,_13;
var _14={},_15={},_16={"8":1,"9":1,"16":1,"33":1,"34":1,"35":1,"36":1,"37":1,"38":1,"39":1,"40":1,"46":1,"33":1,"34":1};
var _17=17;
var _18=objj_msgSend(CPPlatform,"supportsDragAndDrop");
var _19=objj_getClass("CPPlatformWindow");
if(!_19){
objj_exception_throw(new objj_exception(OBJJClassNotFoundException,"*** Could not find definition for class \"CPPlatformWindow\""));
}
var _1a=_19.isa;
class_addMethods(_19,[new objj_method(sel_getUid("_init"),function(_1b,_1c){
with(_1b){
_1b=objj_msgSendSuper({receiver:_1b,super_class:objj_getClass("CPObject")},"init");
if(_1b){
_DOMWindow=window;
_contentRect={origin:{x:0,y:0},size:{width:0,height:0}};
_windowLevels=[];
_windowLayers=objj_msgSend(CPDictionary,"dictionary");
objj_msgSend(_1b,"registerDOMWindow");
objj_msgSend(_1b,"updateFromNativeContentRect");
_charCodes={};
}
return _1b;
}
}),new objj_method(sel_getUid("nativeContentRect"),function(_1d,_1e){
with(_1d){
if(!_DOMWindow){
return objj_msgSend(_1d,"contentRect");
}
if(_DOMWindow.cpFrame){
return _DOMWindow.cpFrame();
}
var _1f={origin:{x:0,y:0},size:{width:0,height:0}};
if(window.screenTop){
_1f.origin={x:_DOMWindow.screenLeft,y:_DOMWindow.screenTop};
}else{
if(window.screenX){
_1f.origin={x:_DOMWindow.screenX,y:_DOMWindow.screenY};
}
}
if(_DOMWindow.innerWidth){
_1f.size={width:_DOMWindow.innerWidth,height:_DOMWindow.innerHeight};
}else{
if(document.documentElement&&document.documentElement.clientWidth){
_1f.size={width:_DOMWindow.document.documentElement.clientWidth,height:_DOMWindow.document.documentElement.clientHeight};
}else{
_1f.size={width:_DOMWindow.document.body.clientWidth,height:_DOMWindow.document.body.clientHeight};
}
}
return _1f;
}
}),new objj_method(sel_getUid("updateNativeContentRect"),function(_20,_21){
with(_20){
if(!_DOMWindow){
return;
}
if(typeof _DOMWindow["cpSetFrame"]==="function"){
return _DOMWindow.cpSetFrame(objj_msgSend(_20,"contentRect"));
}
var _22=objj_msgSend(_20,"contentRect").origin,_23=objj_msgSend(_20,"nativeContentRect").origin;
if(_22.x!==_23.x||_22.y!==_23.y){
_DOMWindow.moveBy(_22.x-_23.x,_22.y-_23.y);
}
var _24=objj_msgSend(_20,"contentRect").size,_25=objj_msgSend(_20,"nativeContentRect").size;
if(_24.width!==_25.width||_24.height!==_25.height){
_DOMWindow.resizeBy(_24.width-_25.width,_24.height-_25.height);
}
}
}),new objj_method(sel_getUid("orderBack:"),function(_26,_27,_28){
with(_26){
if(_DOMWindow){
_DOMWindow.blur();
}
}
}),new objj_method(sel_getUid("registerDOMWindow"),function(_29,_2a){
with(_29){
var _2b=_DOMWindow.document;
_DOMBodyElement=_2b.getElementsByTagName("body")[0];
if(objj_msgSend(CPPlatform,"supportsDragAndDrop")){
_DOMBodyElement.style["-khtml-user-select"]="none";
}
_DOMBodyElement.webkitTouchCallout="none";
_DOMFocusElement=_2b.createElement("input");
...
_DOMPasteboardElement=_2b.createElement("input");
...
objj_msgSend(_29,"_addLayers");
var _2c=objj_msgSend(_29,"class"),_2d=class_getMethodImplementation(_2c,sel_getUid("dragEvent:")),_2e=function(_2f){
_2d(_29,nil,_2f);
},_30=sel_getUid("resizeEvent:"),_31=class_getMethodImplementation(_2c,_30),_32=function(_33){
_31(_29,nil,_33);
},_34=sel_getUid("keyEvent:"),_35=class_getMethodImplementation(_2c,_34),_36=function(_37){
_35(_29,nil,_37);
},_38=sel_getUid("mouseEvent:"),_39=class_getMethodImplementation(_2c,_38),_3a=function(_3b){
_39(_29,nil,_3b);
},_3c=sel_getUid("scrollEvent:"),_3d=class_getMethodImplementation(_2c,_3c),_3e=function(_3f){
_3d(_29,nil,_3f);
},_40=sel_getUid("touchEvent:"),_41=class_getMethodImplementation(_2c,_40),_42=function(_43){
_41(_29,nil,_43);
};
if(_2b.addEventListener){
if(objj_msgSend(CPPlatform,"supportsDragAndDrop")){
_2b.addEventListener("dragstart",_2e,NO);
_2b.addEventListener("drag",_2e,NO);
_2b.addEventListener("dragend",_2e,NO);
_2b.addEventListener("dragover",_2e,NO);
_2b.addEventListener("dragleave",_2e,NO);
_2b.addEventListener("drop",_2e,NO);
}
_2b.addEventListener("mouseup",_3a,NO);
_2b.addEventListener("mousedown",_3a,NO);
_2b.addEventListener("mousemove",_3a,NO);
_2b.addEventListener("keyup",_36,NO);
_2b.addEventListener("keydown",_36,NO);
_2b.addEventListener("keypress",_36,NO);
_2b.addEventListener("touchstart",_42,NO);
_2b.addEventListener("touchend",_42,NO);
_2b.addEventListener("touchmove",_42,NO);
_2b.addEventListener("touchcancel",_42,NO);
_DOMWindow.addEventListener("DOMMouseScroll",_3e,NO);
_DOMWindow.addEventListener("mousewheel",_3e,NO);
_DOMWindow.addEventListener("resize",_32,NO);
_DOMWindow.addEventListener("unload",function(){
objj_msgSend(_29,"updateFromNativeContentRect");
objj_msgSend(_29,"_removeLayers");
_2b.removeEventListener("mouseup",_3a,NO);
_2b.removeEventListener("mousedown",_3a,NO);
_2b.removeEventListener("mousemove",_3a,NO);
_2b.removeEventListener("keyup",_36,NO);
_2b.removeEventListener("keydown",_36,NO);
_2b.removeEventListener("keypress",_36,NO);
_2b.removeEventListener("touchstart",_42,NO);
_2b.removeEventListener("touchend",_42,NO);
_2b.removeEventListener("touchmove",_42,NO);
_DOMWindow.removeEventListener("resize",_32,NO);
_DOMWindow.removeEventListener("DOMMouseScroll",_3e,NO);
_DOMWindow.removeEventListener("mousewheel",_3e,NO);
_29._DOMWindow=nil;
},NO);
}else{
_2b.attachEvent("onmouseup",_3a);
_2b.attachEvent("onmousedown",_3a);
_2b.attachEvent("onmousemove",_3a);
_2b.attachEvent("ondblclick",_3a);
_2b.attachEvent("onkeyup",_36);
_2b.attachEvent("onkeydown",_36);
_2b.attachEvent("onkeypress",_36);
_DOMWindow.attachEvent("onresize",_32);
_DOMWindow.onmousewheel=_3e;
_2b.onmousewheel=_3e;
_2b.body.ondrag=function(){
return NO;
};
_2b.body.onselectstart=function(){
return _DOMWindow.event.srcElement===_DOMPasteboardElement;
};
_DOMWindow.attachEvent("onbeforeunload",function(){
objj_msgSend(_29,"updateFromNativeContentRect");
objj_msgSend(_29,"_removeLayers");
_2b.detachEvent("onmouseup",_3a);
_2b.detachEvent("onmousedown",_3a);
_2b.detachEvent("onmousemove",_3a);
_2b.detachEvent("ondblclick",_3a);
_2b.detachEvent("onkeyup",_36);
_2b.detachEvent("onkeydown",_36);
_2b.detachEvent("onkeypress",_36);
_DOMWindow.detachEvent("onresize",_32);
_DOMWindow.onmousewheel=NULL;
_2b.onmousewheel=NULL;
_2b.body.ondrag=NULL;
_2b.body.onselectstart=NULL;
_29._DOMWindow=nil;
},NO);
}
}
...
if(!objj_msgSend(CPPlatform,"isBrowser")){
_DOMWindow.cpWindowNumber=objj_msgSend(_44._only,"windowNumber");
...
}),new objj_method(sel_getUid("dragEvent:"),function(_4a,_4b,_4c){
with(_4a){
var _4d=_4c.type,_4e=objj_msgSend(CPDragServer,"sharedDragServer"),_4f={x:_4c.clientX,y:_4c.clientY},_50=objj_msgSend(_CPDOMDataTransferPasteboard,"DOMDataTransferPasteboard");
objj_msgSend(_50,"_setDataTransfer:",_4c.dataTransfer);
if(_4c.type==="dragstart"){
objj_msgSend(objj_msgSend(CPRunLoop,"currentRunLoop"),"limitDateForMode:",CPDefaultRunLoopMode);
objj_msgSend(_50,"_setPasteboard:",objj_msgSend(_4e,"draggingPasteboard"));
var _51=objj_msgSend(_4e,"draggedWindow"),_52=objj_msgSend(_51,"frame"),_53=_51._DOMElement;
_53.style.left=-(_52.size.width)+"px";
_53.style.top=-(_52.size.height)+"px";
document.getElementsByTagName("body")[0].appendChild(_53);
var _54=objj_msgSend(_4e,"draggingOffset");
_4c.dataTransfer.setDragImage(_53,_54.width,_54.height);
objj_msgSend(_4e,"draggingStartedInPlatformWindow:globalLocation:",_4a,objj_msgSend(CPPlatform,"isBrowser")?_4f:{x:_4c.screenX,y:_4c.screenY});
}else{
if(_4d==="drag"){
var y=_4c.screenY;
...
objj_msgSend(_4e,"draggingSourceUpdatedWithGlobalLocation:",objj_msgSend(CPPlatform,"isBrowser")?_4f:{x:_4c.screenX,y:y});
}else{
if(_4d==="dragover"||_4d==="dragleave"){
if(_4c.preventDefault){
_4c.preventDefault();
}
var _55="none",_56=objj_msgSend(_4e,"draggingUpdatedInPlatformWindow:location:",_4a,_4f);
if(_56===CPDragOperationMove||_56===CPDragOperationGeneric||_56===CPDragOperationPrivate){
_55="move";
}else{
if(_56===CPDragOperationCopy){
_55="copy";
}else{
if(_56===CPDragOperationLink){
_55="link";
}
}
}
_4c.dataTransfer.dropEffect=_55;
}else{
if(_4d==="dragend"){
var _55=_4c.dataTransfer.dropEffect;
if(_55==="move"){
_56=CPDragOperationMove;
}else{
if(_55==="copy"){
_56=CPDragOperationCopy;
}else{
if(_55==="link"){
_56=CPDragOperationLink;
}else{
_56=CPDragOperationNone;
}
}
}
objj_msgSend(_4e,"draggingEndedInPlatformWindow:globalLocation:operation:",_4a,objj_msgSend(CPPlatform,"isBrowser")?_4f:{x:_4c.screenX,y:_4c.screenY},_56);
}else{
objj_msgSend(_4e,"performDragOperationInPlatformWindow:",_4a);
if(_4c.preventDefault){
_4c.preventDefault();
}
...
}),new objj_method(sel_getUid("keyEvent:"),function(_57,_58,_59){
with(_57){
var _5a,_5b=_59.timeStamp?_59.timeStamp:new Date(),_5c=(_59.target||_59.srcElement),_5d=objj_msgSend(objj_msgSend(CPApp,"keyWindow"),"windowNumber"),_5e=(_59.shiftKey?CPShiftKeyMask:0)|(_59.ctrlKey?CPControlKeyMask:0)|(_59.altKey?CPAlternateKeyMask:0)|(_59.metaKey?CPCommandKeyMask:0);
_13=!(_5e&(CPControlKeyMask|CPCommandKeyMask))||_15[String.fromCharCode(_59.keyCode||_59.charCode).toLowerCase()]||_14[_59.keyCode];
var _5f=NO,_60=NO,_61=nil;
switch(_59.type){
case "keydown":
_keyCode=_59.keyCode;
var _62=String.fromCharCode(_keyCode).toLowerCase();
_61=_5e&CPShiftKeyMask?_62.toUpperCase():_62;
if(_62=="v"&&(_5e&CPPlatformActionKeyMask)){
_DOMPasteboardElement.select();
_DOMPasteboardElement.value="";
_5f=YES;
}else{
if((_62=="c"||_62=="x")&&(_5e&CPPlatformActionKeyMask)){
_60=YES;
}else{
if(!CPFeatureIsCompatible(CPJavascriptRemedialKeySupport)){
return;
}else{
if(!_16[_keyCode]&&(_keyCode==_17||!(_5e&CPControlKeyMask))){
return;
}
}
}
...
case "keypress":
if((_59.target||_59.srcElement)==_DOMPasteboardElement){
return;
}
var _63=_keyCode,_64=_59.keyCode||_59.charCode,_65=(_charCodes[_63]!=nil);
_charCodes[_63]=_64;
var _62=_61||String.fromCharCode(_64),_66=_62.toLowerCase();
if(!_61&&(_5e&CPCommandKeyMask)&&(_5e&CPShiftKeyMask)){
_62=_62.toUpperCase();
}
_5a=objj_msgSend(CPEvent,"keyEventWithType:location:modifierFlags:timestamp:windowNumber:context:characters:charactersIgnoringModifiers:isARepeat:keyCode:",CPKeyDown,location,_5e,_5b,_5d,nil,_62,_66,_65,_63);
if(_5f){
_pasteboardKeyDownEvent=_5a;
window.setNativeTimeout(function(){
objj_msgSend(_57,"_checkPasteboardElement");
},0);
return;
}
break;
case "keyup":
var _63=_59.keyCode,_64=_charCodes[_63];
_charCodes[_63]=nil;
var _62=String.fromCharCode(_64),_66=_62.toLowerCase();
if(!(_5e&CPShiftKeyMask)){
_62=_66;
}
_5a=objj_msgSend(CPEvent,"keyEventWithType:location:modifierFlags:timestamp:windowNumber:context:characters:charactersIgnoringModifiers:isARepeat:keyCode:",CPKeyUp,location,_5e,_5b,_5d,nil,_62,_66,NO,_63);
break;
}
if(_5a){
_5a._DOMEvent=_59;
objj_msgSend(CPApp,"sendEvent:",_5a);
if(_60){
...
_DOMPasteboardElement.select();
window.setNativeTimeout(function(){
objj_msgSend(_57,"_clearPasteboardElement");
},0);
}
return;
}
...
var _6d={x:(x+((_6b.clientX-8)/15)),y:(y+((_6b.clientY-8)/15))};
}else{
var _6d={x:_6b.clientX,y:_6b.clientY};
}
var _6e=0,_6f=0,_70=0,_71=_6b.timeStamp?_6b.timeStamp:new Date(),_72=(_6b.shiftKey?CPShiftKeyMask:0)|(_6b.ctrlKey?CPControlKeyMask:0)|(_6b.altKey?CPAlternateKeyMask:0)|(_6b.metaKey?CPCommandKeyMask:0);
_13=YES;
var _73=objj_msgSend(_69,"hitTest:",_6d);
if(!_73){
return;
}
...
_6e=_6b.wheelDeltaX/120;
_6f=_6b.wheelDeltaY/120;
}else{
if(_6b.wheelDelta){
_6f=_6b.wheelDelta/120;
}else{
if(_6b.detail){
_6f=-_6b.detail/3;
}else{
...
objj_msgSend(_7e,"mouseEvent:",_81);
return;
}else{
if(_80.preventDefault){
_80.preventDefault();
...
objj_msgSend(_83,"mouseEvent:",_85);
...
if(_86==="mouseup"){
if(_mouseIsDown){
_87=_8e(_85,CPLeftMouseUp,_88,_8c,_89,_8b,nil,-1,_11(_lastMouseUp,_89,_88),0);
_mouseIsDown=NO;
_lastMouseUp=_87;
...
if(_86==="mousedown"){
if(_8a.tagName==="INPUT"&&_8a!=_DOMFocusElement){
if(objj_msgSend(CPPlatform,"supportsDragAndDrop")){
...
_DOMEventMode=YES;
_mouseIsDown=YES;
objj_msgSend(CPApp,"sendEvent:",objj_msgSend(CPEvent,"mouseEventWithType:location:modifierFlags:timestamp:windowNumber:context:eventNumber:clickCount:pressure:",CPLeftMouseDown,_88,_8c,_89,_8b,nil,-1,_11(_lastMouseDown,_89,_88),0));
objj_msgSend(CPApp,"sendEvent:",objj_msgSend(CPEvent,"mouseEventWithType:location:modifierFlags:timestamp:windowNumber:context:eventNumber:clickCount:pressure:",CPLeftMouseUp,_88,_8c,_89,_8b,nil,-1,_11(_lastMouseDown,_89,_88),0));
return;
}else{
if(objj_msgSend(CPPlatform,"supportsDragAndDrop")){
...
_87=_8e(_85,CPLeftMouseDown,_88,_8c,_89,_8b,nil,-1,_11(_lastMouseDown,_89,_88),0);
_mouseIsDown=YES;
_lastMouseDown=_87;
}else{
if(_DOMEventMode){
...
var _8f=objj_msgSend(objj_msgSend(CPDragServer,"sharedDragServer"),"isDragging");
if(_87&&(!_8f||!_18)){
_87._DOMEvent=_85;
objj_msgSend(CPApp,"sendEvent:",_87);
}
if(_13&&(!_18||_86!=="mousedown"&&!_8f)){
_12(_85,_83);
}
objj_msgSend(objj_msgSend(CPRunLoop,"currentRunLoop"),"limitDateForMode:",CPDefaultRunLoopMode);
}
}),new objj_method(sel_getUid("layerAtLevel:create:"),function(_90,_91,_92,_93){
with(_90){
var _94=objj_msgSend(_windowLayers,"objectForKey:",_92);
if(!_94&&_93){
_94=objj_msgSend(objj_msgSend(CPDOMWindowLayer,"alloc"),"initWithLevel:",_92);
objj_msgSend(_windowLayers,"setObject:forKey:",_94,_92);
var low=0,_95=_windowLevels.length-1,_96;
while(low<=_95){
_96=FLOOR((low+_95)/2);
if(_windowLevels[_96]>_92){
_95=_96-1;
}else{
low=_96+1;
}
}
objj_msgSend(_windowLevels,"insertObject:atIndex:",_92,_windowLevels[_96]>_92?_96:_96+1);
_94._DOMElement.style.zIndex=_92;
_DOMBodyElement.appendChild(_94._DOMElement);
}
return _94;
}
...
}),new objj_method(sel_getUid("_removeLayers"),function(_9d,_9e){
with(_9d){
var _9f=_windowLevels,_a0=_windowLayers,_a1=_9f.length;
while(_a1--){
var _a2=objj_msgSend(_a0,"objectForKey:",_9f[_a1]);
_DOMBodyElement.removeChild(_a2._DOMElement);
}
}
}),new objj_method(sel_getUid("_addLayers"),function(_a3,_a4){
with(_a3){
var _a5=_windowLevels,_a6=_windowLayers,_a7=_a5.length;
while(_a7--){
var _a8=objj_msgSend(_a6,"objectForKey:",_a5[_a7]);
_DOMBodyElement.appendChild(_a8._DOMElement);
}
}
}),new objj_method(sel_getUid("_dragHitTest:pasteboard:"),function(_a9,_aa,_ab,_ac){
with(_a9){
var _ad=_windowLevels,_ae=_windowLayers,_af=_ad.length;
while(_af--){
if(_ad[_af]>=CPDraggingWindowLevel){
continue;
}
var _b0=objj_msgSend(_ae,"objectForKey:",_ad[_af])._windows,_b1=_b0.length;
while(_b1--){
var _b2=_b0[_b1];
if(objj_msgSend(_b2,"_sharesChromeWithPlatformWindow")){
return objj_msgSend(_b2,"_dragHitTest:pasteboard:",_ab,_ac);
}
if(objj_msgSend(_b2,"containsPoint:",_ab)){
return objj_msgSend(_b2,"_dragHitTest:pasteboard:",_ab,_ac);
}
}
}
...
}),new objj_method(sel_getUid("_propagateCurrentDOMEvent:"),function(_b3,_b4,_b5){
with(_b3){
_13=!_b5;
}
...
var _b9=_windowLevels,_ba=_windowLayers,_bb=_b9.length,_bc=nil;
while(_bb--&&!_bc){
var _bd=objj_msgSend(_ba,"objectForKey:",_b9[_bb])._windows,_be=_bd.length;
while(_be--&&!_bc){
var _bf=_bd[_be];
if(!_bf._ignoresMouseEvents&&objj_msgSend(_bf,"containsPoint:",_b8)){
_bc=_bf;
}
}
}
...
}),new objj_method(sel_getUid("_checkPasteboardElement"),function(_c0,_c1){
with(_c0){
var _c2=_DOMPasteboardElement.value;
if(objj_msgSend(_c2,"length")){
var _c3=objj_msgSend(CPPasteboard,"generalPasteboard");
if(objj_msgSend(_c3,"_stateUID")!=_c2){
objj_msgSend(_c3,"declareTypes:owner:",[CPStringPboardType],_c0);
objj_msgSend(_c3,"setString:forType:",_c2,CPStringPboardType);
}
}
objj_msgSend(_c0,"_clearPasteboardElement");
objj_msgSend(CPApp,"sendEvent:",_pasteboardKeyDownEvent);
_pasteboardKeyDownEvent=nil;
objj_msgSend(objj_msgSend(CPRunLoop,"currentRunLoop"),"limitDateForMode:",CPDefaultRunLoopMode);
}
}),new objj_method(sel_getUid("_clearPasteboardElement"),function(_c4,_c5){
with(_c4){
_DOMPasteboardElement.value="";
_DOMPasteboardElement.blur();
}
})]);
class_addMethods(_1a,[new objj_method(sel_getUid("preventCharacterKeysFromPropagating:"),function(_c6,_c7,_c8){
with(_c6){
for(var i=_c8.length;i>0;i--){
_15[""+_c8[i-1].toLowerCase()]=YES;
}
}
}),new objj_method(sel_getUid("preventCharacterKeyFromPropagating:"),function(_c9,_ca,_cb){
with(_c9){
_15[_cb.toLowerCase()]=YES;
}
}),new objj_method(sel_getUid("clearCharacterKeysToPreventFromPropagating"),function(_cc,_cd){
with(_cc){
_15={};
}
}),new objj_method(sel_getUid("preventKeyCodesFromPropagating:"),function(_ce,_cf,_d0){
with(_ce){
for(var i=_d0.length;i>0;i--){
_14[_d0[i-1]]=YES;
}
}
}),new objj_method(sel_getUid("preventKeyCodeFromPropagating:"),function(_d1,_d2,_d3){
with(_d1){
_14[_d3]=YES;
}
}),new objj_method(sel_getUid("clearKeyCodesToPreventFromPropagating"),function(_d4,_d5){
with(_d4){
_14={};
}
})]);
var _d6=objj_msgSend(CPEvent,"class");
var _8e=function(_d7,_d8,_d9,_da,_db,_dc,_dd,_de,_df,_e0){
_d7.isa=_d6;
_d7._type=_d8;
_d7._location=_d9;
_d7._modifierFlags=_da;
_d7._timestamp=_db;
_d7._windowNumber=_dc;
_d7._window=nil;
_d7._context=_dd;
_d7._eventNumber=_de;
_d7._clickCount=_df;
_d7._pressure=_e0;
return _d7;
};
var _e1=5,_e2=(typeof document!="undefined"&&document.addEventListener)?350:1000;
var _11=function(_e3,_e4,_e5){
if(!_e3){
return 1;
}
var _e6=objj_msgSend(_e3,"locationInWindow");
return (_e4-objj_msgSend(_e3,"timestamp")<_e2&&ABS(_e6.x-_e5.x)<_e1&&ABS(_e6.y-_e5.y)<_e1)?objj_msgSend(_e3,"clickCount")+1:1;
};
var _12=function(_e7,_e8){
_e7.cancelBubble=true;
_e7.returnValue=false;
if(_e7.preventDefault){
_e7.preventDefault();
}
if(_e7.stopPropagation){
_e7.stopPropagation();
}
if(_e7.type===CPDOMEventMouseDown){
_e8._DOMFocusElement.focus();
_e8._DOMFocusElement.blur();
}
};
...
var _f0=objj_msgSend(CPPlatformWindow,"primaryPlatformWindow"),_f1=_f0._windowLevels,_f2=_f0._windowLayers,_f3=_f1.length,_f4=[];
while(_f3--){
var _f5=objj_msgSend(_f2,"objectForKey:",_f1[_f3])._windows,_f6=_f5.length;
while(_f6--){
_f4.push(objj_msgSend(_f5[_f6],"windowNumber"));
}
}
return _f4;
};
