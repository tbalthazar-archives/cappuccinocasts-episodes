I;33;Foundation/CPNotificationCenter.ji;11;CPControl.ji;9;CPImage.ji;14;CPShadowView.jc;10308;
...
{ with(self)
{
    ...
    if (objj_msgSend(self, "currentValueForThemedAttributeName:", "image-scaling") === CPScaleToFit)
    {
