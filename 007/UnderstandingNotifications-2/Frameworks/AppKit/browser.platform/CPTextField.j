i;11;CPControl.ji;17;CPStringDrawing.jc;27646;
...
{ with(self)
{
    ...
    var string = objj_msgSend(self, "stringValue"),
        element = objj_msgSend(objj_msgSend(self, "class"), "_inputElement");

    element.value = string;
    element.style.color = objj_msgSend(objj_msgSend(self, "currentValueForThemedAttributeName:", "text-color"), "cssString");
    element.style.font = objj_msgSend(objj_msgSend(self, "currentValueForThemedAttributeName:", "font"), "cssString");
...
}), new objj_method(sel_getUid("_inputElement"), function(self, _cmd)
{ with(self)
{
